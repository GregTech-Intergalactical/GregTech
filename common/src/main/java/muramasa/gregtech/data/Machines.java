...
public class Machines {
    ...
    public static MultiMachine TREE_GROWTH_SIMULATOR = new MultiMachine(GTIRef.ID, "tree_growth_simulator").setTiers(LV).setMap(RecipeMaps.TREE_GROWTH_SIMULATOR).addFlags(GUI, ITEM, FLUID).setTile(BlockEntityTreeGrowthSimulator::new).setTextureBlock(GregTechBlocks.CASING_PLASTIC);
