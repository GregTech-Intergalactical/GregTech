...
public class StructureInfo {
    ...
    public static void init() {
        ...
        PatternBuilder builder = new PatternBuilder()
                ...
                .at("C", GregTechBlocks.CASING_HEAT_PROOF.defaultBlockState())
        ...
        BLAST_FURNACE.setStructurePattern(
                ...
                builder.at("B", GregTechBlocks.COIL_CUPRONICKEL.defaultBlockState()).description(GregTechBlocks.COIL_CUPRONICKEL.getDescriptionId()).build(),
                // reuse the builder for page COIL_HSSG
                builder.at("B", GregTechBlocks.COIL_HSSG.defaultBlockState()).description(GregTechBlocks.COIL_HSSG.getDescriptionId()).build(),
                // reuse the builder for page COIL_KANTHAL
                builder.at("B", GregTechBlocks.COIL_KANTHAL.defaultBlockState()).description(GregTechBlocks.COIL_KANTHAL.getDescriptionId()).build(),
                ...
                builder.of(3, "CCC", "CFC", "CCK")
                        ...
                        .at("B", GregTechBlocks.COIL_NAQUADAH.defaultBlockState())
                        .description(GregTechBlocks.COIL_NAQUADAH.getDescriptionId())
                        .build());
        builder = new PatternBuilder()
                .of("CCC", "CCC", "CCC").of("CCC", "CAM", "CCC").of(0)
                .at("M", COKE_OVEN, COKE_OVEN.getFirstTier(), Direction.SOUTH)
                .at("C", GregTechBlocks.CASING_FIRE_BRICK.defaultBlockState())
        ...
        builder = new PatternBuilder()
                ...
                .at("C", GregTechBlocks.CASING_FROST_PROOF.defaultBlockState())
                .at("I", HATCH_ITEM_I, HATCH_ITEM_I.getFirstTier(), Direction.SOUTH)
                .at("O", HATCH_ITEM_O, HATCH_ITEM_O.getFirstTier(), Direction.SOUTH)
                .at("E", HATCH_ENERGY, HATCH_ENERGY.getFirstTier(), Direction.NORTH);
        ...
        builder = new PatternBuilder()
                ...
                .at("C", GregTechBlocks.CASING_TURBINE_TUNGSTENSTEEL.defaultBlockState())
