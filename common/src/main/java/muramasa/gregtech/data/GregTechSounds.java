...
public class GregTechSounds {
    ...
    public static final SoundEvent PULVERIZER = AntimatterAPI.register(SoundEvent.class, GTIRef.ID, "pulverizer", new SoundEvent(new ResourceLocation(GTIRef.ID, "pulverizer")));
