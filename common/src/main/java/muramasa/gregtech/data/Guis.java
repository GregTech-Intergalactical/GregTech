...
public class Guis {
    ...
    public static void init(Side side) {
        ...
        PULVERIZER.add(IV, IT_IN, 53, 25).add(IV, IT_OUT, 107, 16).add(IV, IT_OUT, 125, 16).add(IV, IT_OUT, 107, 34)
                .add(IV, IT_OUT, 125, 34);
        RECYCLER.add(COMPRESSOR);
        SCANNER.add(COMPRESSOR);
        WIRE_MILL.add(COMPRESSOR);
        CENTRIFUGE.add(IT_IN, 35, 25).add(IT_IN, 53, 25).add(IT_OUT, 107, 16).add(IT_OUT, 125, 16).add(IT_OUT, 142, 16)
                .add(IT_OUT, 107, 34).add(IT_OUT, 125, 34).add(IT_OUT, 143, 34).add(ENERGY, 80, 63).add(FL_OUT, 107, 63)
                .add(FL_OUT, 125, 63);
        ...
        CHEMICAL_REACTOR.add(IT_IN, 35, 25).add(IT_IN, 53, 25).add(FL_IN, 35, 63).add(FL_IN, 53, 63)
                .add(IT_OUT, 107, 25).add(IT_OUT, 125, 25).add(FL_OUT, 107, 63).add(FL_OUT, 125, 63).add(ENERGY, 80, 63);
