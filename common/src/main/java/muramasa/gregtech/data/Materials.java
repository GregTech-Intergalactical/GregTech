...
public class Materials {
    ...
    public static Material HotHelium = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "hot_helium", 0xffff00, NONE, He));
    ...
    public static Material HeavyWater = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "heavy_water", 0xffff64, NONE));
    public static Material SemiheavyWater = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "semiheavy_water", 0xc8c89b, NONE));
    public static Material TritiatedWater = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "tritiated_water", 0xff6464, NONE));
    public static Material HotHeavyWater = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "hot_heavy_water", 0xffff64, NONE));
    public static Material HotSemiheavyWater = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "hot_semiheavy_water", 0xc8c89b, NONE));
    public static Material HotTritiatedWater = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "hot_tritiated_water", 0xff6464, NONE));
    public static Material HotMoltenSodium = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "hot_molten_sodium", 0x000096, NONE, S));
    public static Material HotMoltenTin = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "hot_molten_tin", 0xdcdcdc, NONE, Sn));
    public static Material HotMoltenLithiumChloride = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "hot_molten_lithium_chloride", 0xdedefa, NONE));
    ...
    public static Material NitroDiesel = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "nitro_diesel", 0xc8ff00, NONE));
    ...
    public static Material NitrogenMonoxide = AntimatterAPI.register(Material.class, new Material(GTIRef.ID, "nitrogen_monoxide", 0x7dc8f0, NONE));
