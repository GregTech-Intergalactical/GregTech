...
public class GregTechMaterialEvents {
    public static void onMaterialEvent(GregTechMaterialEvent event){
         ...
         **  Ore Stones
         **/
        event.setMaterial(Bauxite).asOreStone(ORE_SMALL, ROCK).harvestLevel(1);
        event.setMaterial(Lignite).asGemBasic(false).asOreStone(0, 2, ORE_SMALL, ROCK);
        event.setMaterial(OilShale).asDust(ORE, ORE_STONE, ORE_SMALL, RAW_ORE, RAW_ORE_BLOCK, BEARING_ROCK, ROCK).setExpRange(1,5).harvestLevel(1);
        event.setMaterial(RockSalt).asOreStone(ORE_SMALL, ROCK).harvestLevel(1);
        event.setMaterial(Salt).asOreStone(ORE_SMALL, ROCK).harvestLevel(1);
        /**
         **  Gems
         **/
        /**
        ...
        event.setMaterial(SiliconeRubber).asSolid(900, 0, PLATE, FOIL, MOLTEN);
    ...
    private static void processInto(GregTechMaterialEvent event){
        ...
        event.setMaterial(SiliconeRubber).mats(of(Carbon, 2, Hydrogen, 6, Oxygen, 1, Silicon, 1));
    ...
    private static void toolsAndArmor(GregTechMaterialEvent event){
        ...
        event.setMaterial(SiliconeRubber).tool().toolSpeed(0.3f).toolDurability(1024).toolQuality(1).toolEnchantments(of(Enchantments.KNOCKBACK, 2)).allowedToolTypes(List.of(AntimatterDefaultTools.SOFT_HAMMER)).build();
    ...
    private static void flags(GregTechMaterialEvent event){
        ...
        NOSMASH.add(Wood/* WoodSealed */, Sulfur, Saltpeter, Graphite, /* Paper, */Coal, Charcoal, Lignite, PetroleumCoke, Rubber,
                StyreneButadieneRubber, Plastic, PolyvinylChloride, Polystyrene, SiliconeRubber, NitroDiesel,
        ...
        RUBBERTOOLS.add(Rubber, StyreneButadieneRubber, Plastic, PolyvinylChloride, SiliconeRubber, EpoxyResin);
