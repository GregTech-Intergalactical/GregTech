...
public class GregTechMaterialEvents {
    public static void onMaterialEvent(MaterialEvent event){
        ...
        event.setMaterial(Lignite).asGem(false).asOreStone(0, 2, ORE_SMALL).mats(of(Carbon, 3, Water, 1));
        ...
        event.setMaterial(Lazurite).asGem(false).asOre(2, 5, true).mats(of(Aluminium, 6, Silicon, 6, Calcium, 8, Sodium, 8));
        ...
        event.setMaterial(Phosphorus).asGem(false).asOre(3, 7, true).mats(of(Calcium, 3, Phosphate, 2));
        event.setMaterial(Quartzite).asGem(false, ROCK, ROD).asOre(2, 5, true).mats(of(Silicon, 1, Oxygen, 2));
        ...
        event.setMaterial(Sodalite).asGem(false).asOre(2, 5, true).mats(of(Aluminium, 3, Silicon, 3, Sodium, 4, Chlorine, 1));
    ...
    private static void flags(MaterialEvent event){
        ...
        event.setMaterial(BandedIron).setSmeltInto(Iron, NUGGET, 3);
        event.setMaterial(BrownLimonite).setSmeltInto(Iron, NUGGET, 3);
        event.setMaterial(Cassiterite).setDirectSmeltInto(Tin, NUGGET, 3);
        event.setMaterial(Chalcopyrite).setSmeltInto(Copper, NUGGET, 6);
        event.setMaterial(Cobaltite).setSmeltInto(Cobalt, NUGGET, 6);
        event.setMaterial(Cooperite).setSmeltInto(Platinum, INGOT, 1);
        event.setMaterial(Galena).setDirectSmeltInto(Lead, INGOT, 1);
        event.setMaterial(Garnierite).setSmeltInto(Nickel, NUGGET, 6);
        event.setMaterial(Magnesite).setSmeltInto(Magnesium, NUGGET, 3);
        event.setMaterial(Magnetite).setSmeltInto(Iron, NUGGET, 3);
        event.setMaterial(Malachite).setSmeltInto(Copper, NUGGET, 1);
        event.setMaterial(Molybdenite).setSmeltInto(Molybdenum, NUGGET, 6);
        event.setMaterial(Pentlandite).setSmeltInto(Nickel, INGOT, 1);
        event.setMaterial(Pyrite).setDirectSmeltInto(Iron, NUGGET, 3);
        event.setMaterial(Pyrolusite).setDirectSmeltInto(Manganese, NUGGET, 3);
        event.setMaterial(Sphalerite).setSmeltInto(Zinc, INGOT, 1);
        event.setMaterial(Stibnite).setSmeltInto(Antimony, NUGGET, 3);
        event.setMaterial(Tetrahedrite).setSmeltInto(Copper, NUGGET, 3);
        event.setMaterial(YellowLimonite).setSmeltInto(Iron, NUGGET, 3);
    ...
    private static void antimatterMaterials(MaterialEvent event){
        ...
        event.setMaterial(Coal).asGem(false).flags(ORE_STONE).mats(of(Carbon, 2));
