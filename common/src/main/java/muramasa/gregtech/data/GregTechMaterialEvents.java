...
public class GregTechMaterialEvents {
    public static void onMaterialEvent(GregTechMaterialEvent event){
        ...
        event.setMaterial(Thorium227).asMetal(2028).mats(of(Thorium, 1));
        event.setMaterial(Thorium228).asMetal(2028).mats(of(Thorium, 1));
        event.setMaterial(Thorium229).asMetal(2028).mats(of(Thorium, 1));
        event.setMaterial(Thorium230).asMetal(2028).mats(of(Thorium, 1));
        event.setMaterial(Thorium231).asMetal(2028).mats(of(Thorium, 1));
        event.setMaterial(Thorium232).asMetal(2028).mats(of(Thorium, 1));
        event.setMaterial(Thorium233).asMetal(2028).mats(of(Thorium, 1));
        event.setMaterial(Thorium234).asMetal(2028).mats(of(Thorium, 1));
        ...
        event.setMaterial(Uranium232).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium233).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium234).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium235).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium236).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium237).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium238).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium239).asMetal(1406).mats(of(Uranium, 1));
        event.setMaterial(Uranium240).asMetal(1406).mats(of(Uranium, 1));
        ...
        event.setMaterial(Lazurite).asGemBasic(false).asOre(2, 5, true).harvestLevel(1).mats(of(Aluminium, 6, Silicon, 6, Calcium, 8, Sodium, 8));
        event.setMaterial(LigniteCoke).asGemBasic(false);
        event.setMaterial(Olivine).asGem(false).asOre(3, 7, true).addTools(1.5F, 7.0F, 256, 2, of(Enchantments.SILK_TOUCH, 1)).mats(of(Magnesium, 2, Iron, 1, SiliconDioxide, 2)).harvestLevel(2);
        ...
        event.setMaterial(Ruby).asGem(false).asOre(3, 7, true).addTools(1.5F, 7.0F, 256, 2).mats(of(Chrome, 1, Aluminium, 2, Oxygen, 3)).harvestLevel(2);
    ...
    private static void antimatterMaterials(GregTechMaterialEvent event){
        ...
        event.setMaterial(Diamond).asGem(false).mats(of(Carbon, 64));
        event.setMaterial(Emerald).asGem(false).mats(of(Beryllium, 3, Aluminium, 2, Silicon, 3, Oxygen, 18)).addTools(3.0F, 9.0F, 590, 3);
