...
public class WoodCrafting {
    ...
    public static void loadRecipes(Consumer<FinishedRecipe> consumer, AntimatterRecipeProvider provider) {
        provider.addItemRecipe(consumer, GTIRef.ID, "tiny_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GTIRef.ID, "small_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GTIRef.ID, "normal_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GTIRef.ID, "large_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addItemRecipe(consumer, GTIRef.ID, "huge_wooden_fluid_pipe", "pipes", "has_saw", provider.hasSafeItem(AntimatterDefaultTools.SAW.getTag()),
        ...
        provider.addStackRecipe(consumer, GTIRef.ID, "sticks_4", "wood_stuff", "has_planks", provider.hasSafeItem(ItemTags.PLANKS), new ItemStack(Items.STICK, 4), of('P', ItemTags.PLANKS, 'S', SAW.getTag()), "S", "P", "P");
        ...
        for (String stone : stones) {
            ...
            provider.addItemRecipe(consumer, GTIRef.ID, stone + "_slab_to_" + stone, "slabs", "has_stone", provider.hasSafeItem(slab), full, of('S', slab), pattern);
        }
        ...
        for (String s : wood) {
            ...
            provider.addItemRecipe(consumer, GTIRef.ID, slab.getPath() + "_to_" + name.getPath(), "slabs", "has_stone", provider.hasSafeItem(AntimatterPlatformUtils.getItemFromID(slab)), AntimatterPlatformUtils.getItemFromID(name), of('S', AntimatterPlatformUtils.getItemFromID(slab)), "S", "S");
        }
    }
