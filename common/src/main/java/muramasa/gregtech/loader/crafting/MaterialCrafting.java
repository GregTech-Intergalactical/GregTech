...
public class MaterialCrafting {
    public static void loadRecipes(Consumer<FinishedRecipe> output, AntimatterRecipeProvider provider) {
        addShapelessDustRecipe(output, provider, "bronze_dust", DUST.get(Bronze, 4), DUST.get(AntimatterMaterials.Copper), DUST.get(AntimatterMaterials.Copper), DUST.get(AntimatterMaterials.Copper), DUST.get(Tin));
    }
