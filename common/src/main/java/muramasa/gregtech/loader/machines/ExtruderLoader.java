...
public class ExtruderLoader {
    public static void init() {
        ...
        AntimatterAPI.all(Wire.class).forEach(t -> {
            ...
            EXTRUDING.RB().ii(of(INGOT.getMaterialTag(t.getMaterial()),1),of(GregTechData.ShapeWire,1).setNoConsume()).io(stack).add(t.getMaterial().getMass(),30);
        });
        ...
        AntimatterAPI.all(FluidPipe.class).forEach(t -> {
            ...
            EXTRUDING.RB().ii(of(INGOT.getMaterialTag(t.getMaterial()),3),of(GregTechData.ShapePipeTiny,1).setNoConsume()).io(stackT).add(t.getMaterial().getMass()*3,30);
            EXTRUDING.RB().ii(of(INGOT.getMaterialTag(t.getMaterial()),3),of(GregTechData.ShapePipeSmall,1).setNoConsume()).io(stackS).add(t.getMaterial().getMass()*3,30);
            EXTRUDING.RB().ii(of(INGOT.getMaterialTag(t.getMaterial()),3),of(GregTechData.ShapePipeNormal,1).setNoConsume()).io(stackM).add(t.getMaterial().getMass()*3,30);
            EXTRUDING.RB().ii(of(INGOT.getMaterialTag(t.getMaterial()),6),of(GregTechData.ShapePipeLarge,1).setNoConsume()).io(stackL).add(t.getMaterial().getMass()*6,30);
            EXTRUDING.RB().ii(of(INGOT.getMaterialTag(t.getMaterial()),6),of(GregTechData.ShapePipeHuge,1).setNoConsume()).io(stackH).add(t.getMaterial().getMass()*6,30);
        });
