...
public class MixerLoader {
    ...
    public static void init() {
        ...
        recipes();
        addAsphaltRecipe(Stone, GregTechBlocks.GRAY_ASPHALT);
        addAsphaltRecipe(Andesite, GregTechBlocks.LIGHT_GRAY_ASPHALT);
        addAsphaltRecipe(Basalt, GregTechBlocks.BLACK_ASPHALT);
        addAsphaltRecipe(BlueSchist, GregTechBlocks.LIGHT_BLUE_ASPHALT);
        addAsphaltRecipe(Calcite, GregTechBlocks.WHITE_ASPHALT);
        addAsphaltRecipe(Deepslate, GregTechBlocks.BLACK_ASPHALT);
        addAsphaltRecipe(Diorite, GregTechBlocks.WHITE_ASPHALT);
        addAsphaltRecipe(Endstone, GregTechBlocks.WHITE_ASPHALT);
        addAsphaltRecipe(Granite, GregTechBlocks.RED_ASPHALT);
        addAsphaltRecipe(BlackGranite, GregTechBlocks.BLACK_ASPHALT);
        addAsphaltRecipe(RedGranite, GregTechBlocks.RED_ASPHALT);
        addAsphaltRecipe(Kimberlite, GregTechBlocks.BROWN_ASPHALT);
        addAsphaltRecipe(Komatiite, GregTechBlocks.YELLOW_ASPHALT);
        addAsphaltRecipe(Limestone, GregTechBlocks.ORANGE_ASPHALT);
        addAsphaltRecipe(Marble, GregTechBlocks.WHITE_ASPHALT);
        addAsphaltRecipe(Netherrack, GregTechBlocks.RED_ASPHALT);
        addAsphaltRecipe(OilShale, GregTechBlocks.GRAY_ASPHALT);
        addAsphaltRecipe(Prismarine, GregTechBlocks.LIME_ASPHALT);
        addAsphaltRecipe(DarkPrismarine, GregTechBlocks.GREEN_ASPHALT);
        addAsphaltRecipe(Quartzite, GregTechBlocks.PINK_ASPHALT);
        addAsphaltRecipe(Shale, GregTechBlocks.GRAY_ASPHALT);
    ...
    private static void recipes() {
        ...
        MIXER.RB().ii(DUST.getMaterialIngredient(Wood, 4), DUST.getMaterialIngredient(Sulfur, 1), DUST.getMaterialIngredient(Caesium, 1)).fi(Glue.getLiquid(oneThird)).io(new ItemStack(GregTechItems.SuperFuelBinder, 12)).add("super_fuel_binder_2", 40 * 20, 16);
        MIXER.RB().ii(DUST.getMaterialIngredient(Wood, 4), DUST.getMaterialIngredient(Sulfur, 1), DUST.getMaterialIngredient(Lithium, 1)).fi(Lubricant.getLiquid(300)).io(new ItemStack(GregTechItems.SuperFuelBinder, 8)).add("super_fuel_binder_3", 60 * 20, 16);
        MIXER.RB().ii(DUST.getMaterialIngredient(Wood, 4), DUST.getMaterialIngredient(Sulfur, 1), DUST.getMaterialIngredient(Sodium, 1)).fi(Lubricant.getLiquid(300)).io(new ItemStack(GregTechItems.SuperFuelBinder, 8)).add("super_fuel_binder_4", 60 * 20, 16);
        MIXER.RB().ii(DUST.getMaterialIngredient(Wood, 4), DUST.getMaterialIngredient(Sulfur, 1), DUST.getMaterialIngredient(Caesium, 1)).fi(Lubricant.getLiquid(300)).io(new ItemStack(GregTechItems.SuperFuelBinder, 12)).add("super_fuel_binder_5", 60 * 20, 16);
        ...
        MIXER.RB().ii(BLOCK.getMaterialIngredient(Lignite, 1), of(GregTechItems.SuperFuelBinder, 6)).fi(CetaneBoostedDiesel.getLiquid(1000)).io(GregTechBlocks.SOLID_SUPER_FUEL.asItem()).add("solid_super_fuel_lignite_nitro", 120, 96);
        MIXER.RB().ii(BLOCK.getMaterialIngredient(Charcoal, 1), of(GregTechItems.SuperFuelBinder, 4)).fi(CetaneBoostedDiesel.getLiquid(800)).io(GregTechBlocks.SOLID_SUPER_FUEL.asItem()).add("solid_super_fuel_charcoal_nitro", 120, 96);
        MIXER.RB().ii(BLOCK.getMaterialIngredient(Coal, 1), of(GregTechItems.SuperFuelBinder, 2)).fi(CetaneBoostedDiesel.getLiquid(500)).io(GregTechBlocks.SOLID_SUPER_FUEL.asItem()).add("solid_super_fuel_coal_nitro", 120, 96);
        MIXER.RB().ii(DUST.getMaterialIngredient(Wood, 1)).fi(Glue.getLiquid(25)).io(GregTechItems.WoodPellet).add("wood_pellet", 16, 16);
