...
public class BendingLoader {
    public static void init() {
        ...
        AntimatterMaterialTypes.FOIL.all().forEach(foil -> {
            ...
            BENDING.RB().ii(AntimatterMaterialTypes.PLATE.getMaterialIngredient(foil,1), INT_CIRCUITS.get(1)).io(AntimatterMaterialTypes.FOIL.get(foil,4)).add("foil_" + foil.getId(),foil.getHardness(),24);
        });
