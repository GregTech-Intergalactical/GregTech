...
public class AlloyLoader {
    ...
    public static void init() {
        ...
        ALLOY_SMELTING.RB().ii(of(DUST.getMaterialTag(Materials.Brick), 1), of(DUST.getMaterialTag(AntimatterMaterials.Sand), 2))
                .io(DUST.get(Materials.Fireclay, 1)).add("fireclay",20, 10);
