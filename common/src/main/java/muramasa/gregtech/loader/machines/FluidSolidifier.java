    ...
    public static void init() {
        AntimatterAPI.all(Material.class, mat -> {
            ...
            if (mat.has(AntimatterMaterialTypes.PLATE)) {
                ...
                .fi(mat.getLiquid(amount(1.0f))).io(AntimatterMaterialTypes.PLATE.get(mat,1)).add(30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.GEAR)) {
                FLUID_SOLIDIFYING.RB().ii(RecipeIngredient.of(GregTechData.MoldGear, 1).setNoConsume())
                .fi(mat.getLiquid(amount(4.0f))).io(AntimatterMaterialTypes.GEAR.get(mat,1)).add(30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.INGOT)) {
                ...
                .fi(mat.getLiquid(amount(1.0f))).io(AntimatterMaterialTypes.INGOT.get(mat,1)).add(30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.GEAR_SMALL)) {
                ...
                .fi(mat.getLiquid(amount(1.0f))).io(AntimatterMaterialTypes.GEAR_SMALL.get(mat,1)).add(30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.NUGGET)) {
                ...
                .fi(mat.getLiquid(ratio()/9)).io(AntimatterMaterialTypes.NUGGET.get(mat,1)).add(30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.BLOCK)) {
                ...
                .fi(mat.getLiquid(amount(1.0f))).io(AntimatterMaterialTypes.BLOCK.get().get(mat).asStack(1)).add(30, 16);
            }
        });
    }
