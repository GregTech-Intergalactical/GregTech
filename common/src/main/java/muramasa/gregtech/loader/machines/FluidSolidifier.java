    ...
    public static void init() {
        AntimatterAPI.all(Material.class, mat -> {
            ...
            if (mat.has(AntimatterMaterialTypes.PLATE)) {
                ...
                .fi(mat.getLiquid(L)).io(AntimatterMaterialTypes.PLATE.get(mat,1)).add(mat.getId() + "_plate",30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.GEAR)) {
                FLUID_SOLIDIFYING.RB().ii(RecipeIngredient.of(GregTechData.MoldGear, 1).setNoConsume())
                .fi(mat.getLiquid(L * 4)).io(AntimatterMaterialTypes.GEAR.get(mat,1)).add(mat.getId() + "_gear",30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.INGOT)) {
                ...
                .fi(mat.getLiquid(L)).io(AntimatterMaterialTypes.INGOT.get(mat,1)).add(mat.getId() + "_ingot",30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.GEAR_SMALL)) {
                ...
                .fi(mat.getLiquid(L)).io(AntimatterMaterialTypes.GEAR_SMALL.get(mat,1)).add(mat.getId() + "_gear_small",30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.NUGGET)) {
                ...
                .fi(mat.getLiquid(L / 9)).io(AntimatterMaterialTypes.NUGGET.get(mat,1)).add(mat.getId() + "_nugget",30, 16);
            }
            if (mat.has(AntimatterMaterialTypes.BLOCK)) {
                ...
                .fi(mat.getLiquid(L * 9)).io(AntimatterMaterialTypes.BLOCK.get().get(mat).asStack(1)).add(mat.getId() + "_block",30, 16);
            }
        });
    }
}
