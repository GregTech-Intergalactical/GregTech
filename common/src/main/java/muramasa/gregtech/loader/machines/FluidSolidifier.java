...
public class FluidSolidifier {
    public static void init() {
        ...
        FLUID_SOLIDIFYER.RB().ii(RecipeIngredient.of(GTCoreItems.MoldBottle, 1).setNoConsume()).fi(Glass.getFluidTag(L)).io(Items.GLASS_BOTTLE).add("glass_bottle",12, 4);
        FLUID_SOLIDIFYER.RB().ii(RecipeIngredient.of(GTCoreItems.MoldBlock, 1).setNoConsume()).fi(Glowstone.getFluidTag(L * 4)).io(Items.GLOWSTONE).add("glowstone_block", 12, 4);
        ...
        FLUID_SOLIDIFYER.RB().ii(RecipeIngredient.of(GTCoreItems.MoldBlock, 1).setNoConsume()).fi(DistilledWater.getFluidTag(1000)).io(Items.SNOW_BLOCK).add("snow_block_2", 512, 4);
        ...
        FLUID_SOLIDIFYER.RB().ii(RecipeIngredient.of(GTCoreItems.MoldBall, 1).setNoConsume()).fi(DistilledWater.getFluidTag(250)).io(Items.SNOWBALL).add("snow_ball_2", 128, 4);
    }
}
