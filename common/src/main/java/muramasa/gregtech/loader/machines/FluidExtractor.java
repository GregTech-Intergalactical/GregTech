...
public class FluidExtractor {
    public static void init() {
        ...
        FLUID_EXTRACTOR.RB().ii(Items.SALMON).fo(FishOil.getLiquid(60)).add("fish_oil_salmon", 16, 4);
        FLUID_EXTRACTOR.RB().ii(Items.TROPICAL_FISH).fo(FishOil.getLiquid(70)).add("fish_oil_tropical_fish", 16, 4);
        FLUID_EXTRACTOR.RB().ii(Items.INK_SAC).fo(SquidInk.getLiquid(L)).add("squid_ink", 128, 4);
    }
