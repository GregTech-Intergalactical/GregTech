...
public class ChemicalReactorLoader {
    ...
    private static void miscCarbohydrates() {
        ...
        CHEMICAL_REACTING.RB().fi(Dimethyldichlorosilane.getLiquid(144), AntimatterMaterials.Water.getLiquid(288)).fo(HydrochloricAcid.getLiquid(288)).io(DUST.get(Polydimethylsiloxane,1)).add(240, 96);
        ...
        CHEMICAL_REACTING.RB().ii(of(DUST.get(SodiumHydroxide,1))).fi(Glycerol.getLiquid(144),HydrochloricAcid.getLiquid(144)).io(DUST.get(Salt,1)).fo(Epichlorohydrin.getLiquid(144), AntimatterMaterials.Water.getLiquid(288)).add(480, 30);
        ...
        CHEMICAL_REACTING.RB().ii(of(DUST.get(SodiumHydroxide),1).setNoConsume()).fi(MethylAcetate.getLiquid(144), AntimatterMaterials.Water.getLiquid(144)).fo(AceticAcid.getLiquid(144),Methanol.getLiquid(144)).add(260, 60);
    }
    ...
    private static void inorganicChemistry(){
        ...
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sodium,2))).fi(AntimatterMaterials.Water.getLiquid(288)).fo(Hydrogen.getGas(144)).io(DUST.get(SodiumHydroxide,2)).add(40, 8);
        ...
        CHEMICAL_REACTING.RB().fi(NitricAcid.getLiquid(4*144),MethylAcetate.getLiquid(288)).io(DUST.get(Carbon,5)).fo(Tetranitromethane.getLiquid(144), AntimatterMaterials.Water.getLiquid(8*144)).add(480, 120);
