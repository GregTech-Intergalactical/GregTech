...
public class ChemicalReactorLoader {
    ...
    private static void sulfuric() {
        //SULFURIC ACID
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur,1)), INT_CIRCUITS.get(1).setNoConsume()).fi(Water.getLiquid(2000)).fo(SulfuricAcid.getLiquid(3000)).add("sulfuric_acid",1150, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur,1)), INT_CIRCUITS.get(2).setNoConsume()).fi(Water.getLiquid(3000), Oxygen.getGas(3000)).fo(SulfuricAcid.getLiquid(7000)).add("sulfuric_acid_2",480, 30);
        ...
        //HYDROGEN SULFIDE
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur,1))).fi(Hydrogen.getGas(2000)).fo(HydrogenSulfide.getGas(3000)).add("hydrogen_sulfide",60, 8);
    ...
    private static void plastics() {
        ...
        CHEMICAL_REACTING.RB().fi(Oxygen.getGas(16000),Naphtha.getLiquid(1296)).ii(of(DUST_TINY.get(Titanium),1)).fo(Polyethylene.getLiquid(1296)).add("ethylene_to_polyethylene_3",640, 30);
    ...
    private static void miscCarbohydrates() {
        ...
        CHEMICAL_REACTING.RB().fi(Benzene.getLiquid(1000)).ii(of(DUST.get(Sulfur,1))).fo(PolyphenyleneSulfide.getLiquid(2000)).add("polyphenylene_sulfide",320, 30);
        //EPICHLOROHYDRIN
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon,1))).fi(LPG.getGas(432),Chlorine.getGas(1000)).fo(Epichlorohydrin.getLiquid(432)).add("epichlorohydrin",480, 30);
        //METHANOL
        ...
        //CARBON DIOXIDE
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Charcoal, 1)), INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(2000)).fo(CarbonDioxide.getGas(3000)).io(DUST_TINY.get(Ash, 1)).add("carbon_dioxide",40, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon, 1)), INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(2000)).fo(CarbonDioxide.getGas(3000)).add("carbon_dioxide_1",40, 8);
        CHEMICAL_REACTING.RB().ii(of(GEM.get(Charcoal, 1)), INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(2000)).fo(CarbonDioxide.getGas(3000)).io(DUST_TINY.get(Ash, 1)).add("carbon_dioxide_2",40, 8);
        CHEMICAL_REACTING.RB().ii(of(GEM.get(Coal, 1)), INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(2000)).fo(CarbonDioxide.getGas(3000)).io(DUST_TINY.get(Ash, 1)).add("carbon_dioxide_3",40, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Coal, 1)), INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(2000)).fo(CarbonDioxide.getGas(3000)).io(DUST_TINY.get(Ash, 1)).add("carbon_dioxide_4",40, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Calcite, 5)), INT_CIRCUITS.get(1).setNoConsume()).fo(CarbonDioxide.getGas(3000)).io(DUST.get(Quicklime, 2)).add("carbon_dioxide_5",240, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Magnesia, 5)), INT_CIRCUITS.get(1).setNoConsume()).fo(CarbonDioxide.getGas(3000)).io(DUST.get(Magnesia, 2)).add("carbon_dioxide_6",240, 30);
        ...
        //BIODIESEL
        CHEMICAL_REACTING.RB().fi(SeedOil.getLiquid(6000),Methanol.getLiquid(1000)).ii(of(DUST_TINY.get(SodiumHydroxide, 1))).fo(BioDiesel.getLiquid(6000),Glyceryl.getLiquid(1000)).add("biodiesel_and_glyceryl",600, 30);
        CHEMICAL_REACTING.RB().fi(FishOil.getLiquid(6000),Methanol.getLiquid(1000)).ii(of(DUST_TINY.get(SodiumHydroxide, 1))).fo(BioDiesel.getLiquid(6000),Glyceryl.getLiquid(1000)).add("biodiesel_and_glyceryl_1",600, 30);
        CHEMICAL_REACTING.RB().fi(SeedOil.getLiquid(6000),Ethanol.getLiquid(1000)).ii(of(DUST_TINY.get(SodiumHydroxide, 1))).fo(BioDiesel.getLiquid(6000),Glyceryl.getLiquid(1000)).add("biodiesel_and_glyceryl_2",600, 30);
        CHEMICAL_REACTING.RB().fi(FishOil.getLiquid(6000),Methanol.getLiquid(1000)).ii(of(DUST_TINY.get(SodiumHydroxide, 1))).fo(BioDiesel.getLiquid(6000),Glyceryl.getLiquid(1000)).add("biodiesel_and_glyceryl_3",600, 30);
        //GELLED TOLUENE
    ...
    private static void inorganicChemistry(){
        ...
        //CARBON MONOXIDE
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Charcoal, 1)), INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(1000)).fo(CarbonMonoxide.getGas(2000)).io(DUST_TINY.get(Ash, 1)).add("carbon_monoxide",40, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon, 1)), INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(1000)).fo(CarbonMonoxide.getGas(2000)).add("carbon_monoxide_1",40, 8);
        CHEMICAL_REACTING.RB().ii(of(GEM.get(Charcoal, 1)), INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(1000)).fo(CarbonMonoxide.getGas(2000)).io(DUST_TINY.get(Ash, 1)).add("carbon_monoxide_2",40, 8);
        CHEMICAL_REACTING.RB().ii(of(GEM.get(Coal, 1)), INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(1000)).fo(CarbonMonoxide.getGas(2000)).io(DUST_TINY.get(Ash, 1)).add("carbon_monoxide_3",40, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Coal, 1)), INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(1000)).fo(CarbonMonoxide.getGas(2000)).io(DUST_TINY.get(Ash, 1)).add("carbon_monoxide_4",40, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon, 1))).fi(CarbonDioxide.getGas(3000)).fo(CarbonMonoxide.getGas(4000)).add("carbon_monoxide_5",800, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Rutile, 1), DUST.get(Carbon, 2)), INT_CIRCUITS.get(1).setNoConsume()).fi(Chlorine.getGas(4000)).fo(CarbonMonoxide.getGas(2000), Titaniumtetrachloride.getLiquid(1000)).add("carbon_monoxide_6",500, 480);
        //AMMONIA
        ...
        //CALCITE
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon,1)),of(DUST.get(Calcium,1))).fi(Oxygen.getGas(3000)).io(DUST.get(Calcite,5)).add("calcite",500, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Quicklime,2))).fi(CarbonDioxide.getGas(3000)).io(DUST.get(Calcite,5)).add("calcite_1",80, 30);
        //MAGNESITE
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Magnesia,2))).fi(CarbonDioxide.getGas(3000)).io(DUST.get(Magnesite,5)).add("magnesite",80, 30);
        //GLYCERYL TRINITRATE
        ...
        CHEMICAL_REACTING.RB().fi(Nitrogen.getGas(1000),Water.getLiquid(2000)).ii(of(DUST.get(Carbon, 1))).fo(GlycerylTrinitrate.getLiquid(4000)).add("glyceryl_trinitrate_1",2700,30);
        //SALTPETER
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Potassium,1))).fi(Nitrogen.getGas(1000), Oxygen.getGas(3000)).io(DUST.get(Saltpeter,5)).add("saltpeter",180,30);
        //SODIUM PERSULFATE
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sodium,1), DUST.get(Sulfur, 1))).fi(Oxygen.getGas(4000)).fo(SodiumPersulfate.getLiquid(6000)).add("sodium_persulfate",8000, 30);
        }
/*
...
*/
   ...
   */
    ...
    private static void misc(){
        ...
        //RADON
        CHEMICAL_REACTING.RB().ii(of(INGOT.get(Plutonium239, 3))).fo(Radon.getGas(50)).io(DUST.get(Plutonium239, 3)).add("radon",6000,8);
        //TNT
        CHEMICAL_REACTING.RB().ii(of(DUST.get(GelledToluene, 4))).fi(SulfuricAcid.getLiquid(250)).io(Items.TNT).add("tnt",200,24);
        //WATER
        CHEMICAL_REACTING.RB().fi(Hydrogen.getGas(1000), Oxygen.getGas(500)).fo(Water.getLiquid(1500)).add("water",5,30);
        //GLISTERING MELON SLICE
        CHEMICAL_REACTING.RB().ii(of(NUGGET.get(Gold, 8)), RecipeIngredient.of(Items.MELON_SLICE)).io(Items.GLISTERING_MELON_SLICE).add("glistering_melon_slice",50,30);
        //GOLDEN APPLE
        CHEMICAL_REACTING.RB().ii(of(INGOT.get(Gold, 8)), RecipeIngredient.of(Items.APPLE)).io(Items.GOLDEN_APPLE).add("golden_apple",50,30);
        //MAGMA CREAM
        ...
        //Golden CARROT
        CHEMICAL_REACTING.RB().ii(of(NUGGET.get(Gold, 8)), RecipeIngredient.of(Items.CARROT)).io(Items.GOLDEN_CARROT).add("golden_carrot",50,30);
        //TINY PILE OF PLATINUM GROUP SLUDGE DUST
        CHEMICAL_REACTING.RB().ii(of(CRUSHED_PURIFIED.get(Chalcopyrite, 1))).fi(NitricAcid.getLiquid(1000)).io(DUST_TINY.get(PlatinumGroupSludge, 1)).fo(BlueVitriol.getLiquid(9000)).add("tiny_pile_of_platinum_group_sludge",50,30);
        CHEMICAL_REACTING.RB().ii(of(CRUSHED_PURIFIED.get(Pentlandite, 1))).fi(NitricAcid.getLiquid(1000)).io(DUST_TINY.get(PlatinumGroupSludge, 1)).fo(NickelSulfate.getLiquid(9000)).add("tiny_pile_of_platinum_group_sludge_1",50,30);
        //NITROUS OXIDE
        ...
        //CERTUS QUARTZ
        CHEMICAL_REACTING.RB().fi(Water.getLiquid(1000)).ii(of(DUST.get(CertusQuartz, 3), DUST.get(Sodium, 1))).io(GEM.get(CertusQuartz, 3)).add("certus_quartz",500,30);
        //NETHER QUARTZ
        CHEMICAL_REACTING.RB().fi(Water.getLiquid(1000)).ii(of(DUST.get(Quartz, 3), DUST.get(Sodium, 1))).io(GEM.get(Quartz, 3)).add("quartz",500,30);
        //QUARTZITE
        ...
        //SILICONE RUBBER
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Polydimethylsiloxane, 9), DUST.get(Sulfur, 1))).fo(SiliconeRubber.getLiquid(1296)).add("silcone_rubber",600,30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Silicon, 1))).fi(Epichlorohydrin.getLiquid(144)).fo(SiliconeRubber.getLiquid(144)).add("silcone_rubber_1",240,96);
        //STYRENE-BUTADIENE RUBBER
        CHEMICAL_REACTING.RB().ii(of(DUST.get(RawStyreneButadieneRubber, 9), DUST.get(Sulfur, 1))).fo(StyreneButadieneRubber.getLiquid(1296)).add("styrenebutadiene_rubber",600,30);
        //POLYCAPROLACTAM
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Saltpeter, 1))).fi(Naphtha.getLiquid(576)).fo(Polycaprolactam.getLiquid(1296)).add("polycaprolactam",640,30);
        //URANIUM 238 DUST
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Uraninite, 1), DUST.get(Magnesium, 1))).io(DUST.get(Uranium238, 1)).add("uranium238",1000,30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Uraninite, 1), DUST.get(Aluminium, 1))).io(DUST.get(Uranium238, 1)).add("uranium238_1",1000,30);
        //CHEMICAL DYES
        ...
        //INDIUM CONCENTRATE
        CHEMICAL_REACTING.RB().ii(of(CRUSHED_PURIFIED.get(Galena, 3), CRUSHED_PURIFIED.get(Sphalerite, 1))).fi(SulfuricAcid.getLiquid(4000)).fo(IndiumConcentrate.getLiquid(8000)).add("indiumconcentrate",60,150);
        //HYDROGEN
        ...
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Aluminium, 4))).fi(IndiumConcentrate.getLiquid(8000)).fo(LeadZincSolution.getLiquid(8000)).io(DUST_TINY.get(Indium, 1)).add("tiny_pile_of_indium_dust",50,600);
        ...
        //CHLORINE
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sodium, 1), DUST.get(MagnesiumChloride, 2))).fo(Chlorine.getGas(3000)).io(DUST_SMALL.get(Magnesium, 6)).add("chlorine",300,240);
