...
public class ChemicalReactorLoader {
    ...
    private static void miscCarbohydrates() {
        ...
        CHEMICAL_REACTING.RB().fi(Dimethyldichlorosilane.getLiquid(1000), AntimatterMaterials.Water.getLiquid(2000)).fo(HydrochloricAcid.getLiquid(2000)).io(DUST.get(Polydimethylsiloxane,1)).add("hydrochloric_acid",240, 96);
        ...
        CHEMICAL_REACTING.RB().fi(AceticAcid.getLiquid(1000),Methanol.getLiquid(1000)).fo(MethylAcetate.getLiquid(1000), AntimatterMaterials.Water.getLiquid(1000)).add("methyl_acetate",240, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(SodiumHydroxide,1))).fi(Glyceryl.getLiquid(1000),HydrochloricAcid.getLiquid(1000)).io(DUST.get(Salt,1)).fo(Epichlorohydrin.getLiquid(1000), AntimatterMaterials.Water.getLiquid(2000)).add("epichlorohydrin",480, 30);
        ...
        CHEMICAL_REACTING.RB().fi(Hydrogen.getGas(3000),CarbonDioxide.getGas(1000)).fo(Methanol.getLiquid(1000), AntimatterMaterials.Water.getLiquid(1000)).add("methanol",360, 96);
        ...
        CHEMICAL_REACTING.RB().fi(Ethylene.getGas(2000),Oxygen.getGas(1000),AceticAcid.getLiquid(2000)).fo(VinylAcetate.getLiquid(2000), AntimatterMaterials.Water.getLiquid(2000)).add("vinyl_acetate",180, 30);
        CHEMICAL_REACTING.RB().fi(Methanol.getLiquid(1000),HydrochloricAcid.getLiquid(1000)).fo(Chloromethane.getGas(1000), AntimatterMaterials.Water.getLiquid(1000)).add("chloromethane",160, 30);
    ...
    private static void inorganicChemistry(){
        ...
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sodium,1))).fi(AntimatterMaterials.Water.getLiquid(1000)).fo(Hydrogen.getGas(1000)).io(DUST.get(SodiumHydroxide,1)).add("sodium_hydroxide",40, 8);
        ...
        CHEMICAL_REACTING.RB().fi(NitrogenDioxide.getGas(3000), AntimatterMaterials.Water.getLiquid(1000)).fo(NitricOxide.getGas(1000),NitricAcid.getLiquid(2000)).add("nitric_oxide",40, 240);
        CHEMICAL_REACTING.RB().fi(Ammonia.getGas(4000),Oxygen.getGas(5000)).fo(NitricOxide.getGas(4000), AntimatterMaterials.Water.getLiquid(6000)).add("nitric_oxide_2",320, 30);
        ...
        CHEMICAL_REACTING.RB().fi(HypochlorousAcid.getLiquid(1000),Ammonia.getGas(1000)).fo(Chloramine.getLiquid(1000), AntimatterMaterials.Water.getLiquid(1000)).add("chloramine",160, 30);
        CHEMICAL_REACTING.RB().fi(Methanol.getLiquid(2000),Ammonia.getGas(1000)).fo(Dimethylamine.getGas(1000), AntimatterMaterials.Water.getLiquid(2000)).add("dimethylamine_2",240, 120);
        ...
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(7000),Ammonia.getGas(4000)).fo(DinitrogenTetroxide.getGas(2000), AntimatterMaterials.Water.getLiquid(6000)).add("dinitrogen_tetroxide",480, 30);
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(2000),Ammonia.getGas(1000)).fo(NitricAcid.getLiquid(1000), AntimatterMaterials.Water.getLiquid(1000)).add("nitric_acid",480, 30);
        ...
        CHEMICAL_REACTING.RB().ii(RecipeIngredient.of(DUST.get(Sodium,1))).fi(AntimatterMaterials.Water.getLiquid(1000)).io(DUST.get(SodiumHydroxide,1)).fo(Hydrogen.getGas(1000)).add("sodium_hydroxide_2",30,120);
        CHEMICAL_REACTING.RB().fi(Chlorine.getGas(2000),AntimatterMaterials.Water.getLiquid(1000)).fo(HydrochloricAcid.getLiquid(1000),HypochlorousAcid.getLiquid(1000)).add("hydrochloric_acid_6",30,120);
        CHEMICAL_REACTING.RB().fi(NitrogenDioxide.getGas(2000)).fo(DinitrogenTetroxide.getGas(1000)).add("dinitrogen_tetroxide_2",30,120);
        CHEMICAL_REACTING.RB().ii(RecipeIngredient.of(DUST.get(PhosphorousPentoxide,1))).fi(AntimatterMaterials.Water.getLiquid(6000)).fo(PhosphoricAcid.getLiquid(4000)).add("phosphoric_acid",30,120);
        CHEMICAL_REACTING.RB().ii(RecipeIngredient.of(DUST.get(Salt,1))).fi(SulfuricAcid.getLiquid(1000)).io(DUST.get(SodiumBisulfate,1)).fo(HydrochloricAcid.getLiquid(1000)).add("sodium_bisulfate",30,120);
        CHEMICAL_REACTING.RB().ii(RecipeIngredient.of(DUST.get(Magnesia,1))).fi(CarbonDioxide.getGas(1000)).io(DUST.get(Magnesite,1)).add("magnesite_2",30,120);
        CHEMICAL_REACTING.RB().ii(RecipeIngredient.of(DUST.get(Quicklime,1))).fi(CarbonDioxide.getGas(1000)).io(DUST.get(Calcite,1)).fo().add("calcite_3",30,120);
        ...
        CHEMICAL_REACTING.RB().fi(HydrogenSulfide.getGas(1000),Oxygen.getGas(3000)).fo(SulfurDioxide.getGas(1000),AntimatterMaterials.Water.getLiquid(1000)).add("sulfuric_dioxide_3",30,120);
        ...
        CHEMICAL_REACTING.RB().fi(Cumene.getLiquid(1000),Oxygen.getGas(1000),AntimatterMaterials.Water.getLiquid(1000)).fo(Phenol.getLiquid(1000),Acetone.getLiquid(1000)).add("phenol_3",30,120);
        ...
        CHEMICAL_REACTING.RB().fi(Ammonia.getGas(1000),HypochlorousAcid.getLiquid(1000)).fo(Chloramine.getLiquid(1000),AntimatterMaterials.Water.getLiquid(1000)).add("chloramine_2",30,120);
        ...
        CHEMICAL_REACTING.RB().fi(Ammonia.getGas(2000),Oxygen.getGas(5000)).fo(NitricOxide.getGas(2000),AntimatterMaterials.Water.getLiquid(3000)).add("nitric_oxide_3",30,120);
        ...
        CHEMICAL_REACTING.RB().ii(RecipeIngredient.of(DUST.get(Potassium,1))).fi(NitricAcid.getLiquid(2000)).io(DUST.get(Saltpeter,1)).fo(Hydrogen.getGas(1000)).add("saltpeter",30,180);
        CHEMICAL_REACTING.RB().fi(AceticAcid.getLiquid(1000),Ethylene.getGas(1000),Oxygen.getGas(1000)).fo(VinylAcetate.getLiquid(1000),AntimatterMaterials.Water.getLiquid(1000)).add("vinyl_acetate_2",30,180);
        CHEMICAL_REACTING.RB().fi(NitricOxide.getGas(2000),Oxygen.getGas(1000),AntimatterMaterials.Water.getLiquid(1000)).fo(NitricAcid.getLiquid(2000)).add("nitric_acid_2",120, 30);
        CHEMICAL_REACTING.RB().fi(NitrogenDioxide.getGas(3000),AntimatterMaterials.Water.getLiquid(1000)).fo(NitricAcid.getLiquid(2000),NitricOxide.getGas(1000)).add("nitric_acid_3",120, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(SodiumHydroxide,2))).fi(PeroxydisulfuricAcid.getLiquid(1000)).fo(SodiumPersulfate.getLiquid(1000),AntimatterMaterials.Water.getLiquid(2000)).add("sodium_persulfate",300, 30);
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(2)).fi(SulfuricAcid.getLiquid(2000)).fo(PeroxydisulfuricAcid.getLiquid(1000),Hydrogen.getGas(2000)).add("peroxydisulfuric_acid",240, 30);
    }
    ...
    private static void alkaneToAlkanol(Material alkane, Material alkanol, int mol_alk, int mol_ox, RecipeIngredient... circuit){
        FluidStack fi = alkane.has(AntimatterMaterialTypes.LIQUID) ? alkane.getLiquid(mol_alk * 1000) : alkane.has(AntimatterMaterialTypes.GAS) ? alkane.getGas(mol_alk * 1000) : FluidStack.EMPTY;
        FluidStack fo = alkanol.has(AntimatterMaterialTypes.LIQUID) ? alkanol.getLiquid(mol_alk * 1000) : alkanol.has(AntimatterMaterialTypes.GAS) ? alkanol.getGas(mol_alk * 1000) : FluidStack.EMPTY;
    ...
    private static void alkanolToAlkene(Material alkanol, Material alkene, int mol_alk, int mol_sulf){
        FluidStack fi = alkanol.has(AntimatterMaterialTypes.LIQUID) ? alkanol.getLiquid(mol_alk * 1000) : alkanol.has(AntimatterMaterialTypes.GAS) ? alkanol.getGas(mol_alk * 1000) : FluidStack.EMPTY;
        FluidStack fo = alkene.has(AntimatterMaterialTypes.LIQUID) ? alkene.getLiquid(mol_alk * 1000) : alkene.has(AntimatterMaterialTypes.GAS) ? alkene.getGas(mol_alk * 1000) : FluidStack.EMPTY;
        if (fi.isEmpty() || fo.isEmpty()) return;
    ...
    private static void nuclear_processing() {
        ...
        CHEMICAL_REACTING.RB().fi(Thoriumdioxidedinitrate.getLiquid(10000),Ammonia.getGas(22000)).io(DUST.get(Ammoniumdithoranate,5)).fo(AntimatterMaterials.Water.getLiquid(13000),NitricOxide.getGas(32000)).add("ammoniumdithoranate",120,1000);
        CHEMICAL_REACTING.RB().fi(Uraniumdioxidedinitrate.getLiquid(10000),Ammonia.getGas(22000)).io(DUST.get(Ammoniumdiuranate,5)).fo(AntimatterMaterials.Water.getLiquid(13000),NitricOxide.getGas(32000)).add("ammoniumdiuranate",120,1000);

        CHEMICAL_REACTING.RB().ii(of(DUST.get(Ammoniumdithoranate))).fi(Hydrogen.getGas(4000)).io(DUST.get(ThoriumDioxide,2)).fo(Ammonia.getGas(2000),AntimatterMaterials.Water.getLiquid(3000)).add("secondary_thorium_dioxide",120,1000);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Ammoniumdiuranate))).fi(Hydrogen.getGas(4000)).io(DUST.get(UraniumDioxide,2)).fo(Ammonia.getGas(2000),AntimatterMaterials.Water.getLiquid(3000)).add("secondary_uranium_dioxide",120,1000);

        CHEMICAL_REACTING.RB().ii(of(DUST.get(ThoriumDioxide))).fi(HydrofluoricAcid.getLiquid(4000)).fo(ThoriumTetrafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000)).add("thoriumtetrafluoride",120,1000);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(UraniumDioxide))).fi(HydrofluoricAcid.getLiquid(4000)).fo(UraniumTetrafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000)).add("uraniumtetrafluoride",120,1000);
        ...
        CHEMICAL_REACTING.RB().fi(Thorium227Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Thorium227Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("thorium227_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Thorium228Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Thorium228Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("thorium228_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Thorium229Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Thorium229Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("thorium229_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Thorium230Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Thorium230Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("thorium230_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Thorium231Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Thorium231Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("thorium231_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Thorium233Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Thorium233Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("thorium233_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Thorium234Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Thorium234Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("thorium234_hexafluoride_reduction",120,1000);

        CHEMICAL_REACTING.RB().fi(Uranium232Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium232Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium232_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium233Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium233Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium233_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium234Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium234Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium234_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium235Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium235Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium235_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium236Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium236Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium236_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium237Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium237Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium237_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium238Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium238Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium238_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium239Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium239Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium239_hexafluoride_reduction",120,1000);
        CHEMICAL_REACTING.RB().fi(Uranium240Hexafluoride.getGas(1000),AntimatterMaterials.Water.getLiquid(2000),Hydrogen.getGas(2000)).io(DUST.get(Uranium240Dioxide)).fo(HydrofluoricAcid.getLiquid(6000)).add("uranium240_hexafluoride_reduction",120,1000);
