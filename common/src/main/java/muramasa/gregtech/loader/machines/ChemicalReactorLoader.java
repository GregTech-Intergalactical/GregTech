...
public class ChemicalReactorLoader {
    ...
    private static void miscCarbohydrates() {
        ...
        CHEMICAL_REACTING.RB().fi(SulfuricAcid.getLiquid(1000),AceticAcid.getLiquid(1000)).fo(Ethenone.getGas(1000),DilutedSulfuricAcid.getLiquid(1000)).add("ethenone",160, 120);
        ...
        CHEMICAL_REACTING.RB().fi(Dimethylamine.getGas(1000),Chloramine.getLiquid(1000)).fo(Dimethylhydrazine.getLiquid(1000),DilutedHydrochloricAcid.getLiquid(1000)).add("dimethylhydrazine",240, 360);
    ...
    private static void inorganicChemistry(){
        ...
        CHEMICAL_REACTING.RB().fi(Methanol.getLiquid(2000),Ammonia.getGas(1000)).fo(Dimethylamine.getGas(1000), AntimatterMaterials.Water.getLiquid(2000)).add("dimethylamine",240, 120);
        ...
        CHEMICAL_REACTING.RB().fi(Benzene.getLiquid(1000),Ethylene.getGas(1000)).fo(Styrene.getLiquid(1000),Hydrogen.getGas(2000)).add("styrene",30,120);
        ...
        CHEMICAL_REACTING.RB().fi(Propene.getGas(1000),Chlorine.getGas(1000)).fo(AllylChloride.getLiquid(1000),HydrochloricAcid.getLiquid(1000)).add("allyl_chloride",30,120);
