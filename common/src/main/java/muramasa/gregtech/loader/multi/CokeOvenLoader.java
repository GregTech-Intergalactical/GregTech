...
public class CokeOvenLoader {
    public static void init() {
        ...
        COKE_OVEN.RB().ii(RecipeIngredient.of(CRUSHED.getMaterialTag(Lignite), 1)).io(GEM.get(LigniteCoke, 1)).fo(Creosote.getLiquid(200)).add("lignite_coal_coke_crushed",600, 0);
        COKE_OVEN.RB().ii(RecipeIngredient.of(CRUSHED_PURIFIED.getMaterialTag(Coal), 1)).io(GEM.get(CoalCoke, 1)).fo(Creosote.getLiquid(200)).add("coal_coke_crushed_purified",600, 0);
        COKE_OVEN.RB().ii(RecipeIngredient.of(CRUSHED_PURIFIED.getMaterialTag(Lignite), 1)).io(GEM.get(LigniteCoke, 1)).fo(Creosote.getLiquid(200)).add("lignite_coal_coke_crushed_purified",600, 0);
