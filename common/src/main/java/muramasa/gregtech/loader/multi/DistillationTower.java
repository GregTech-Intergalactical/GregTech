...
public class DistillationTower {
    ...
    private static void init6U(){
        addDistillationDistillingRecipe(OilLight, 25, 64, 64,
                new FluidProduct(LightFuel, 10),
                new FluidProduct(HeavyFuel,15),
                ...
                new FluidProduct(SulfuricAcid, 25));
        addDistillationDistillingRecipe(Oil, 25, 64, 64,
                new FluidProduct(LightFuel, 15),
                new FluidProduct(HeavyFuel,25),
        ...
        addDistillationDistillingRecipe(OilHeavy, 25, 64, 64,
                new FluidProduct(LightFuel, 20),
                new FluidProduct(HeavyFuel,30),
