...
public class TreeGrowthSimulator {
    public static void init() {
        ...
        TREE_GROWTH_SIMULATOR.RB().ii(RecipeIngredient.of(Items.DARK_OAK_SAPLING, 4), RecipeIngredient.of(GTCoreItems.Fertilizer)).fi(Water.getLiquid(1000)).io(new ItemStack(Items.DARK_OAK_LOG, 40), new ItemStack(Items.DARK_OAK_SAPLING, 5), new ItemStack(Items.STICK, 1), new ItemStack(Items.APPLE)).chances(1.0, 1.0, 1.0, 0.5).add("dark_oak_log", 400, 4);
