...
public class Materials {
    ...
    public static Material Aluminium = AntimatterAPI.registerIfAbsent(Material.class,"aluminium",() -> new Material(Ref.ID, "aluminium", 0x80c8f0, DULL, Al).asMetal(933, 1700, PLATE, ROD, SCREW, BOLT, RING, GEAR, FRAME, GEAR_SMALL).asOre().addTools(1.5F, 10.0F, 140, 2));
    public static Material Beryllium = AntimatterAPI.registerIfAbsent(Material.class,"beryllium",() -> new Material(Ref.ID, "beryllium", 0x64b464, METALLIC, Be).asMetal(1560, 0).asOre().addTools(2.0F, 14.0F, 64, 2));
    public static Material Bismuth = AntimatterAPI.registerIfAbsent(Material.class,"bismuth",() -> new Material(Ref.ID, "bismuth", 0x64a0a0, METALLIC, Bi).asMetal(544, 0, PLATE).asOre());
    ...
    public static Material Gold = AntimatterAPI.registerIfAbsent(Material.class,"gold",() -> new Material(Ref.ID, "gold", 0xffff1e, SHINY, Au).asMetal(1337, 0, FOIL, ROD, WIRE_FINE, GEAR).asOre().addTools(GOLD.getAttackDamage(), GOLD.getEfficiency(), GOLD.getMaxUses(), GOLD.getHarvestLevel()));
    public static Material Iridium = AntimatterAPI.registerIfAbsent(Material.class,"iridium",() -> new Material(Ref.ID, "iridium", 0xf0f0f5, DULL, Ir).asMetal(2719, 2719, FRAME).asOre().addTools(5.0F, 8.0F, 2560, 4));
    public static Material Iron = AntimatterAPI.registerIfAbsent(Material.class,"iron",() -> new Material(Ref.ID, "iron", 0xc8c8c8, METALLIC, Fe).asMetal(1811, 0, RING, GEAR, FRAME).asOre().asPlasma().addTools(IRON.getAttackDamage(), IRON.getEfficiency(), IRON.getMaxUses(), IRON.getHarvestLevel()));
    ...
    public static Material Lead = AntimatterAPI.registerIfAbsent(Material.class,"lead",() -> new Material(Ref.ID, "lead", 0x8c648c, DULL, Pb).asMetal(600, 0, PLATE, PLATE_DENSE, FOIL, ROD, FRAME).asOre());
    public static Material Manganese = AntimatterAPI.registerIfAbsent(Material.class,"manganese",() -> new Material(Ref.ID, "manganese", 0xfafafa, DULL, Mn).asMetal(1519, 0).asOre());
    public static Material Molybdenum = AntimatterAPI.registerIfAbsent(Material.class,"molybdenum",() -> new Material(Ref.ID, "molybdenum", 0xb4b4dc, SHINY, Mo).asMetal(2896, 0).asOre().addTools(2.0F, 7.0F, 512, 2));
    public static Material Neodymium = AntimatterAPI.registerIfAbsent(Material.class,"neodymium",() -> new Material(Ref.ID, "neodymium", 0x646464, METALLIC, Nd).asMetal(1297, 1297, PLATE, ROD).asOre()); //TODO: Bastnasite or Monazite for Ore For);
    ...
    public static Material Nickel = AntimatterAPI.registerIfAbsent(Material.class,"nickel",() -> new Material(Ref.ID, "nickel", 0xc8c8fa, METALLIC, Ni).asMetal(1728, 0, PLATE).asOre().asPlasma());
    ...
    public static Material Palladium = AntimatterAPI.registerIfAbsent(Material.class,"palladium",() -> new Material(Ref.ID, "palladium", 0x808080, SHINY, Pd).asMetal(1828, 1828).asOre().addTools(3.0F, 10.0F, 420, 2));
    public static Material Platinum = AntimatterAPI.registerIfAbsent(Material.class,"platinum",() -> new Material(Ref.ID, "platinum", 0xffffc8, SHINY, Pt).asMetal(2041, 0, PLATE, FOIL, ROD, WIRE_FINE).asOre().addTools(4.5F, 18.0F, 48, 2));
    ...
    public static Material Silver = AntimatterAPI.registerIfAbsent(Material.class,"silver",() -> new Material(Ref.ID, "silver", 0xdcdcff, SHINY, Ag).asMetal(1234, 0, PLATE).asOre());
    public static Material Thorium = AntimatterAPI.registerIfAbsent(Material.class,"thorium",() -> new Material(Ref.ID, "thorium", 0x001e00, SHINY, Th).asMetal(2115, 0).asOre().addTools(1.5F, 6.0F, 512, 2));
    public static Material Titanium = AntimatterAPI.registerIfAbsent(Material.class,"titanium",() -> new Material(Ref.ID, "titanium", 0xdca0f0, METALLIC, Ti).asMetal(1941, 1940,  PLATE, ROD, SCREW, BOLT, RING, GEAR, FRAME, GEAR_SMALL,ROTOR).asOre().addTools(2.5F, 7.0F, 1600, 3));
    ...
    public static Material Uranium = AntimatterAPI.registerIfAbsent(Material.class,"uranium_238",() -> new Material(Ref.ID, "uranium_238", 0x32f032, METALLIC, U).asMetal(1405, 0).asOre());
    ...
    public static Material Graphite = AntimatterAPI.registerIfAbsent(Material.class,"graphite",() -> new Material(Ref.ID, "graphite", 0x808080, DULL).asDust().asOre());
    ...
    public static Material Copper = AntimatterAPI.registerIfAbsent(Material.class,"copper",() -> new Material(Ref.ID, "copper", 0xff6400, SHINY, Cu).asMetal(1357, 0, PLATE, ROD, FOIL, WIRE_FINE, GEAR).asOre());
    ...
    public static Material Lithium = AntimatterAPI.registerIfAbsent(Material.class,"lithium",() -> new Material(Ref.ID, "lithium", 0xe1dcff, DULL, Li).asSolid(454, 0).asOre());
    ...
    public static Material Sulfur = AntimatterAPI.registerIfAbsent(Material.class,"sulfur",() -> new Material(Ref.ID, "sulfur", 0xc8c800, DULL, S).asDust(388).asOre().asPlasma());
    ...
    public static Material Tin = AntimatterAPI.registerIfAbsent(Material.class,"tin",() -> new Material(Ref.ID, "tin", 0xdcdcdc, DULL, Sn).asMetal(505, 505, PLATE, ROD, SCREW, BOLT, RING, GEAR, FOIL, WIRE_FINE, FRAME, ROTOR).asOre());
    ...
    public static Material Zinc = AntimatterAPI.registerIfAbsent(Material.class,"zinc",() -> new Material(Ref.ID, "zinc", 0xfaf0f0, METALLIC, Zn).asMetal(692, 0, PLATE, FOIL).asOre());
    ...
    public static Material Oilsands = AntimatterAPI.registerIfAbsent(Material.class,"oilsands",() -> new Material(Ref.ID, "oilsands", 0x0a0a0a, NONE).asOre(true));
    ...
    public static Material Almandine = AntimatterAPI.registerIfAbsent(Material.class,"almandine",() -> new Material(Ref.ID, "almandine", 0xff0000, ROUGH).asOre().mats(of(Aluminium, 2, Iron, 3, Silicon, 3, Oxygen, 12)));
    public static Material Andradite = AntimatterAPI.registerIfAbsent(Material.class,"andradite",() -> new Material(Ref.ID, "andradite", 0x967800, ROUGH).asOre().mats(of(Calcium, 3, Iron, 2, Silicon, 3, Oxygen, 12)));
    ...
    public static Material BandedIron = AntimatterAPI.registerIfAbsent(Material.class,"banded_iron",() -> new Material(Ref.ID, "banded_iron", 0x915a5a, DULL).asOre(true).mats(of(Iron, 2, Oxygen, 3)));
    public static Material BrownLimonite = AntimatterAPI.registerIfAbsent(Material.class,"brown_limonite",() -> new Material(Ref.ID, "brown_limonite", 0xc86400, METALLIC).asOre(true).mats(of(Iron, 1, Hydrogen, 1, Oxygen, 2)));
    public static Material Calcite = AntimatterAPI.registerIfAbsent(Material.class,"calcite",() -> new Material(Ref.ID, "calcite", 0xfae6dc, DULL).asOre(true).mats(of(Calcium, 1, Carbon, 1, Oxygen, 3)));
    public static Material Cassiterite = AntimatterAPI.registerIfAbsent(Material.class,"cassiterite",() -> new Material(Ref.ID, "cassiterite", 0xdcdcdc, METALLIC).asOre().mats(of(Tin, 1, Oxygen, 2)));
    public static Material Chalcopyrite = AntimatterAPI.registerIfAbsent(Material.class,"chalcopyrite",() -> new Material(Ref.ID, "chalcopyrite", 0xa07828, DULL).asOre().mats(of(Copper, 1, Iron, 1, Sulfur, 2)));
    ...
    public static Material Cobaltite = AntimatterAPI.registerIfAbsent(Material.class,"cobaltite",() -> new Material(Ref.ID, "cobaltite", 0x5050fa, METALLIC).asOre(true).mats(of(Cobalt, 1, Arsenic, 1, Sulfur, 1)));
    public static Material Cooperite = AntimatterAPI.registerIfAbsent(Material.class,"cooperite",() -> new Material(Ref.ID, "cooperite", 0xffffc8, METALLIC).asOre().mats(of(Platinum, 3, Nickel, 1, Sulfur, 1, Palladium, 1)));
    ...
    public static Material Galena = AntimatterAPI.registerIfAbsent(Material.class,"galena",() -> new Material(Ref.ID, "galena", 0x643c64, DULL).asOre().mats(of(Lead, 3, Silver, 3, Sulfur, 2)));
    public static Material Garnierite = AntimatterAPI.registerIfAbsent(Material.class,"garnierite",() -> new Material(Ref.ID, "garnierite", 0x32c846, METALLIC).asOre().mats(of(Nickel, 1, Oxygen, 1)));
    public static Material Grossular = AntimatterAPI.registerIfAbsent(Material.class,"grossular",() -> new Material(Ref.ID, "grossular", 0xc86400, ROUGH).asOre().mats(of(Calcium, 3, Aluminium, 2, Silicon, 3, Oxygen, 12)));
    public static Material Ilmenite = AntimatterAPI.registerIfAbsent(Material.class,"ilmenite",() -> new Material(Ref.ID, "ilmenite", 0x463732, METALLIC).asOre().mats(of(Iron, 1, Titanium, 1, Oxygen, 3)));
    public static Material Rutile = AntimatterAPI.registerIfAbsent(Material.class,"rutile",() -> new Material(Ref.ID, "rutile", 0xd40d5c, GEM_H).asOre().mats(of(Titanium, 1, Oxygen, 2)));
    ...
    public static Material Magnesite = AntimatterAPI.registerIfAbsent(Material.class,"magnesite",() -> new Material(Ref.ID, "magnesite", 0xfafab4, METALLIC).asOre(true).mats(of(Magnesium, 1, Carbon, 1, Oxygen, 3)));
    public static Material Magnetite = AntimatterAPI.registerIfAbsent(Material.class,"magnetite",() -> new Material(Ref.ID, "magnetite", 0x1e1e1e, METALLIC).asOre().mats(of(Iron, 3, Oxygen, 4)));
    public static Material Molybdenite = AntimatterAPI.registerIfAbsent(Material.class,"molybdenite",() -> new Material(Ref.ID, "molybdenite", 0x91919, METALLIC).asOre(true).mats(of(Molybdenum, 1, Sulfur, 2)));
    ...
    public static Material Phosphate = AntimatterAPI.registerIfAbsent(Material.class,"phosphate",() -> new Material(Ref.ID, "phosphate", 0xffff00, DULL).asOre(true).mats(of(Phosphor, 1, Oxygen, 4)));
    ...
    public static Material Pyrite = AntimatterAPI.registerIfAbsent(Material.class,"pyrite",() -> new Material(Ref.ID, "pyrite", 0x967828, ROUGH).asOre().mats(of(Iron, 1, Sulfur, 2)));
    public static Material Pyrolusite = AntimatterAPI.registerIfAbsent(Material.class,"pyrolusite",() -> new Material(Ref.ID, "pyrolusite", 0x9696aa, DULL).asOre().mats(of(Manganese, 1, Oxygen, 2)));
    public static Material Pyrope = AntimatterAPI.registerIfAbsent(Material.class,"pyrope",() -> new Material(Ref.ID, "pyrope", 0x783264, METALLIC).asOre().mats(of(Aluminium, 2, Magnesium, 3, Silicon, 3, Oxygen, 12)));
    ...
    public static Material Saltpeter = AntimatterAPI.registerIfAbsent(Material.class,"saltpeter",() -> new Material(Ref.ID, "saltpeter", 0xe6e6e6, FINE).asOre().mats(of(Potassium, 1, Nitrogen, 1, Oxygen, 3)));
    public static Material Scheelite = AntimatterAPI.registerIfAbsent(Material.class,"scheelite",() -> new Material(Ref.ID, "scheelite", 0xc88c14, DULL).asDust(2500).asOre(true).mats(of(Tungsten, 1, Calcium, 2, Oxygen, 4)));
    ...
    public static Material Spessartine = AntimatterAPI.registerIfAbsent(Material.class,"spessartine",() -> new Material(Ref.ID, "spessartine", 0xff6464, DULL).asOre().mats(of(Aluminium, 2, Manganese, 3, Silicon, 3, Oxygen, 12)));
    public static Material Sphalerite = AntimatterAPI.registerIfAbsent(Material.class,"sphalerite",() -> new Material(Ref.ID, "sphalerite", 0xffffff, DULL).asOre().mats(of(Zinc, 1, Sulfur, 1)));
    public static Material Stibnite = AntimatterAPI.registerIfAbsent(Material.class,"stibnite",() -> new Material(Ref.ID, "stibnite", 0x464646, METALLIC).asOre().mats(of(Antimony, 2, Sulfur, 3)));
    public static Material Tetrahedrite = AntimatterAPI.registerIfAbsent(Material.class,"tetrahedrite",() -> new Material(Ref.ID, "tetrahedrite", 0xc82000, DULL).asOre(true).mats(of(Copper, 3, Antimony, 1, Sulfur, 3, Iron, 1)));
    public static Material Tungstate = AntimatterAPI.registerIfAbsent(Material.class,"tungstate",() -> new Material(Ref.ID, "tungstate", 0x373223, DULL).asOre(true).mats(of(Tungsten, 1, Lithium, 2, Oxygen, 4)));
    public static Material Uraninite = AntimatterAPI.registerIfAbsent(Material.class,"uraninite",() -> new Material(Ref.ID, "uraninite", 0x232323, METALLIC).asOre(true).mats(of(Uranium, 1, Oxygen, 2)));
    public static Material Uvarovite = AntimatterAPI.registerIfAbsent(Material.class,"uvarovite",() -> new Material(Ref.ID, "uvarovite", 0xb4ffb4, DIAMOND).asOre().mats(of(Calcium, 3, Chrome, 2, Silicon, 3, Oxygen, 12)));
    ...
    public static Material Wulfenite = AntimatterAPI.registerIfAbsent(Material.class,"wulfenite",() -> new Material(Ref.ID, "wulfenite", 0xff8000, DULL).asOre(true).mats(of(Lead, 1, Molybdenum, 1, Oxygen, 4)));
    public static Material YellowLimonite = AntimatterAPI.registerIfAbsent(Material.class,"yellow_limonite",() -> new Material(Ref.ID, "yellow_limonite", 0xc8c800, METALLIC).asOre(true).mats(of(Iron, 1, Hydrogen, 1, Oxygen, 2)));
    ...
    public static Material VanadiumMagnetite = AntimatterAPI.registerIfAbsent(Material.class,"vanadium_magnetite",() -> new Material(Ref.ID, "vanadium_magnetite", 0x23233c, METALLIC).asOre(true).mats(of(Magnetite, 1, Vanadium, 1)));
    public static Material Bastnasite = AntimatterAPI.registerIfAbsent(Material.class,"bastnasite",() -> new Material(Ref.ID, "bastnasite", 0xc86e2d, FINE).asOre(true).mats(of(Cerium, 1, Carbon, 1, Fluorine, 1, Oxygen, 3)));
    public static Material Pentlandite = AntimatterAPI.registerIfAbsent(Material.class,"pentlandite",() -> new Material(Ref.ID, "pentlandite", 0xa59605, DULL).asOre().mats(of(Nickel, 9, Sulfur, 8)));
    public static Material Spodumene = AntimatterAPI.registerIfAbsent(Material.class,"spodumene",() -> new Material(Ref.ID, "spodumene", 0xbeaaaa, DULL).asOre(true).mats(of(Lithium, 1, Aluminium, 1, Silicon, 2, Oxygen, 6)));
    public static Material Tantalite = AntimatterAPI.registerIfAbsent(Material.class,"tantalite",() -> new Material(Ref.ID, "tantalite", 0x915028, METALLIC).asOre(true).mats(of(Manganese, 1, Tantalum, 2, Oxygen, 6)));
    public static Material Lepidolite = AntimatterAPI.registerIfAbsent(Material.class,"lepidolite",() -> new Material(Ref.ID, "lepidolite", 0xf0328c, FINE).asOre(true).mats(of(Potassium, 1, Lithium, 3, Aluminium, 4, Fluorine, 2, Oxygen, 10))); //TODO: Ore Ge);
    public static Material Glauconite = AntimatterAPI.registerIfAbsent(Material.class,"glauconite",() -> new Material(Ref.ID, "glauconite", 0x82b43c, DULL).asOre(true).mats(of(Potassium, 1, Magnesium, 2, Aluminium, 4, Hydrogen, 2, Oxygen, 12))); //TODO: Ore Ge);
    public static Material Bentonite = AntimatterAPI.registerIfAbsent(Material.class,"bentonite",() -> new Material(Ref.ID, "bentonite", 0xf5d7d2, ROUGH).asOre(true).mats(b -> b.put(Sodium, 1).put(Magnesium, 6).put(Silicon, 12).put(Hydrogen, 6).put(Water, 5).put(Oxygen, 36))); //TODO: Ore Ge);
    public static Material Pitchblende = AntimatterAPI.registerIfAbsent(Material.class,"pitchblende",() -> new Material(Ref.ID, "pitchblende", 0xc8d200, DULL).asOre(true).mats(of(Uraninite, 3, Thorium, 1, Lead, 1)));
    public static Material Malachite = AntimatterAPI.registerIfAbsent(Material.class,"malachite",() -> new Material(Ref.ID, "malachite", 0x055f05, DULL).asOre(true).mats(of(Copper, 2, Carbon, 1, Hydrogen, 2, Oxygen, 5)));
    public static Material Barite = AntimatterAPI.registerIfAbsent(Material.class,"barite",() -> new Material(Ref.ID, "barite", 0xe6ebff, DULL).asOre(true).mats(of(Barium, 1, Sulfur, 1, Oxygen, 4)));
    public static Material Talc = AntimatterAPI.registerIfAbsent(Material.class,"talc",() -> new Material(Ref.ID, "talc", 0x5ab45a, DULL).asOre(true).mats(of(Magnesium, 3, Silicon, 4, Hydrogen, 2, Oxygen, 12)));
    public static Material Soapstone = AntimatterAPI.registerIfAbsent(Material.class,"soapstone",() -> new Material(Ref.ID, "soapstone", 0x5f915f, DULL).asOre(true).mats(of(Magnesium, 3, Silicon, 4, Hydrogen, 2, Oxygen, 12))); //TODO: Ore Ge);
    ...
    public static Material NetherQuartz = AntimatterAPI.registerIfAbsent(Material.class,"nether_quartz",() -> new Material(Ref.ID, "nether_quartz", 0xe6d2d2, QUARTZ).asGemBasic(false).asOre());
    ...
    public static Material Lazurite = AntimatterAPI.registerIfAbsent(Material.class,"lazurite",() -> new Material(Ref.ID, "lazurite", 0x6478ff, LAPIS).asGemBasic(false).asOre(2, 5, true).mats(of(Aluminium, 6, Silicon, 6, Calcium, 8, Sodium, 8))); //TODO I think this is needed);
    ...
    public static Material Sodalite = AntimatterAPI.registerIfAbsent(Material.class,"sodalite",() -> new Material(Ref.ID, "sodalite", 0x1414ff, LAPIS).asGemBasic(false).asOre(2, 5, true).mats(of(Aluminium, 3, Silicon, 3, Sodium, 4, Chlorine, 1))); //TODO I think this is needed);
    ...
    public static Material Cinnabar = AntimatterAPI.registerIfAbsent(Material.class,"cinnabar",() -> new Material(Ref.ID, "cinnabar", 0x960000, ROUGH).asOre(true).mats(of(Mercury, 1, Sulfur, 1)));
    ...
    public static Material StainlessSteel = AntimatterAPI.registerIfAbsent(Material.class,"stainless_steel",() -> new Material(Ref.ID, "stainless_steel", 0xc8c8dc, SHINY).asMetal(1700, 1700, PLATE, ROD, SCREW, BOLT, RING, GEAR, FRAME, ROTOR, GEAR_SMALL).addTools(Steel).mats(of(Iron, 6, Chrome, 1, Manganese, 1, Nickel, 1)).asOre());
    ...
    public static Material WroughtIron = AntimatterAPI.registerIfAbsent(Material.class,"wrought_iron",() -> new Material(Ref.ID, "wrought_iron", 0xc8b4b4, METALLIC).asMetal(1811, 0, PLATE, ROD, SCREW, BOLT, RING, GEAR, FRAME, ROTOR, GEAR_SMALL).addTools(Iron).mats(of(Iron, 1)).asOre());
    ...
    public static Material TungstenSteel = AntimatterAPI.registerIfAbsent(Material.class,"tungstensteel",() -> new Material(Ref.ID, "tungstensteel", 0x6464a0, METALLIC).asMetal(3000, 3000, PLATE, ROD, SCREW, BOLT, RING, GEAR, FRAME, ROTOR, GEAR_SMALL).asOre().addTools(4.0F, 8.0F, 2560, 4).mats(of(Steel, 1, Tungsten, 1)));
    ...
    public static Material Naquadah = AntimatterAPI.registerIfAbsent(Material.class,"naquadah",() -> new Material(Ref.ID, "naquadah", 0x323232, METALLIC).asMetal(5400, 5400).asOre().addHandleStat(102, 0.5F, of(Enchantments.EFFICIENCY, 2)).addTools(4.0F, 6.0F, 890, 4));
    ...
    public static Material EnrichedNaquadah = AntimatterAPI.registerIfAbsent(Material.class,"enriched_naquadah",() -> new Material(Ref.ID, "enriched_naquadah", 0x323232, SHINY).asMetal(4500, 4500, ORE_SMALL, ORE).addTools(5.0F, 6.0F, 1280, 4));
    ...
    public static Material Quartzite = AntimatterAPI.registerIfAbsent(Material.class,"quartzite",() -> new Material(Ref.ID, "quartzite", 0xe6cdcd, QUARTZ).asGemBasic(false, ROCK).asOre(2, 5, true).mats(of(Silicon, 1, Oxygen, 2)));
    ...
    public static Material Lignite = AntimatterAPI.registerIfAbsent(Material.class,"lignite_coal",() -> new Material(Ref.ID, "lignite_coal", 0x644646, LIGNITE).asGemBasic(false).asOreStone(0, 2, ORE_SMALL).mats(of(Carbon, 3, Water, 1)));
    ...
    public static Material Bauxite = AntimatterAPI.registerIfAbsent(Material.class,"bauxite",() -> new Material(Ref.ID, "bauxite", 0xc86400, DULL).asOreStone(ORE_SMALL).mats(of(Rutile, 2, Aluminium, 16, Hydrogen, 10, Oxygen, 11)));
    public static Material OilShale = AntimatterAPI.registerIfAbsent(Material.class,"oil_shale",() -> new Material(Ref.ID, "oil_shale", 0x32323c, NONE).asOreStone(ORE_SMALL));
