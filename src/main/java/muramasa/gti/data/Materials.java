...
public class Materials {
    ...
    public static Material EnrichedNaquadah = AntimatterAPI.registerIfAbsent(Material.class,"enriched_naquadah",() -> new Material(Ref.ID, "enriched_naquadah", 0x323232, SHINY).asMetal(4500, 4500, ORE_SMALL).addTools(5.0F, 6.0F, 1280, 4));
