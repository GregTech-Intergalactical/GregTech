...
public class Guis {
    ...
    public static void init(Dist side) {
        ...
        CHEMICAL_REACTOR.add(IT_IN, 35, 25).add(IT_IN, 53, 25).add(FL_IN, 35, 63).add(FL_IN, 53, 63).add(IT_OUT, 107, 25).add(IT_OUT, 107, 25).add(FL_OUT, 107, 63).add(FL_OUT, 125, 63);
