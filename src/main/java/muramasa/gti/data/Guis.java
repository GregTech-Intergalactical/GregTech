...
//        GregTechAPI.registerJEICategory(RecipeMaps.SMELTING, Guis.MULTI_DISPLAY_COMPACT);
        ...
        TRANSFORMER_DIGITAL.getGui()
                .addButton(10, 18, 14, 14, MACHINE_BUTTON, APAD_LEFT)
                .addButton(25, 18, 14, 14, MACHINE_BUTTON, PAD_LEFT)
                .addButton(10, 33, 14, 14, MACHINE_BUTTON, APAD_LEFT)
                .addButton(25, 33, 14, 14, MACHINE_BUTTON, PAD_LEFT)
                .addButton(10, 48, 14, 14, MACHINE_BUTTON, APAD_LEFT)
                .addButton(25, 48, 14, 14, MACHINE_BUTTON, PAD_LEFT)
                .addButton(10, 63, 14, 14, MACHINE_BUTTON, APAD_LEFT)
                .addButton(25, 63, 14, 14, MACHINE_BUTTON, PAD_LEFT)
                .addButton(137, 18, 14, 14, MACHINE_BUTTON, PAD_RIGHT)
                .addButton(152, 18, 14, 14, MACHINE_BUTTON, APAD_RIGHT)
                .addButton(137, 33, 14, 14, MACHINE_BUTTON, PAD_RIGHT)
                .addButton(152, 33, 14, 14, MACHINE_BUTTON, APAD_RIGHT)
                .addButton(137, 48, 14, 14, MACHINE_BUTTON, PAD_RIGHT)
                .addButton(152, 48, 14, 14, MACHINE_BUTTON, APAD_RIGHT)
                .addButton(137, 63, 14, 14, MACHINE_BUTTON, PAD_RIGHT)
                .addButton(152, 63, 14, 14, MACHINE_BUTTON, APAD_RIGHT);


        COVER_CONVEYOR.getGui()
                .addSwitch(18, 49, 32, 32, COVER_SWITCH, GREY, IMPORT)
                .addSwitch(54, 49, 32, 32, COVER_SWITCH, GREY, EXPORT)
                .addSwitch(18, 85, 32, 32, COVER_SWITCH, GREY, STOP)
                .addSwitch(54, 85, 32, 32, COVER_SWITCH, GREY, TORCH_ON, TORCH_OFF)
                .addSwitch(18, 121, 32, 32, COVER_SWITCH, GREY, EXPORT)
                .addSwitch(54, 121, 32, 32, COVER_SWITCH, GREY, INPUT_OFF)
                .addText("Import/Export", 90, 49)
                .addText("Conditional", 90, 85)
                .addText("Enable Input", 90, 121);
    }
}
