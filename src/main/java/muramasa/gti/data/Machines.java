...
public class Machines {
    ...
    public static BasicMachine ASSEMBLER = new BasicMachine(Ref.ID, "assembler", ASSEMBLING, GUI, ITEM);
    ...
    public static BasicMachine CUTTER = new BasicMachine(Ref.ID, "cutter", CUTTING, GUI, ITEM);
    ...
    public static BasicMachine THERMAL_CENTRIFUGE = new BasicMachine(Ref.ID, "thermal_centrifuge", THERMAL_CENTRIFUGING, GUI, ITEM);
    ...
    public static SteamMachine COAL_BOILER = new SteamMachine(Ref.ID, "coal_boiler", SMALL_BOILERS, BRONZE, STEEL, GUI, ITEM, FLUID, Textures.BOILER_HANDLER);
    public static SteamMachine LAVA_BOILER = new SteamMachine(Ref.ID, "lava_boiler", SMALL_BOILERS, STEEL, GUI, ITEM, FLUID); //TODO
    public static SteamMachine SOLAR_BOILER = new SteamMachine(Ref.ID, "solar_boiler", SMALL_BOILERS, BRONZE, GUI, ITEM, FLUID); //TODO
    public static SteamMachine STEAM_FURNACE = new SteamMachine(Ref.ID, "steam_furnace", BRONZE, STEEL, GUI, ITEM, FLUID, STEAM_SMELTING);
    public static SteamMachine STEAM_PULVERIZER = new SteamMachine(Ref.ID, "steam_pulverizer", BRONZE, STEEL, GUI, ITEM, FLUID, STEAM_PULVERIZING);
    public static SteamMachine STEAM_EXTRACTOR = new SteamMachine(Ref.ID, "steam_extractor", BRONZE, STEEL, GUI, ITEM, FLUID, STEAM_EXTRACTING);
    public static SteamMachine STEAM_FORGE_HAMMER = new SteamMachine(Ref.ID, "steam_forge_hammer", BRONZE, STEEL, GUI, ITEM, FLUID, STEAM_HAMMERING);
    public static SteamMachine STEAM_COMPRESSOR = new SteamMachine(Ref.ID, "steam_compressor", BRONZE, STEEL, GUI, ITEM, FLUID, STEAM_COMPRESSING);
    public static SteamMachine STEAM_ALLOY_SMELTER = new SteamMachine(Ref.ID, "steam_alloy_smelter",BRONZE, STEEL, GUI, ITEM, FLUID, STEAM_ALLOY_SMELTING);
    ...
    public static MultiMachine LARGE_TURBINE = new MultiMachine(Ref.ID, "large_turbine", HV, EV, IV, UV, GUI, FLUID).setTile(m -> () -> new TileEntityLargeTurbine(m));
    public static MultiMachine HEAT_EXCHANGER = new MultiMachine(Ref.ID, "heat_exchanger", EV, GUI, FLUID).setTile(m -> () -> new TileEntityHeatExchanger(m));
    public static MultiMachine OIL_DRILLING_RIG = new MultiMachine(Ref.ID, "oil_drilling_rig", EV, IV, LUV, ZPM, GUI, FLUID).setTile(m -> () -> new TileEntityOilDrillingRig(m));
    public static MultiMachine OIL_CRACKING_UNIT = new MultiMachine(Ref.ID, "oil_cracking_unit", HV, GUI, FLUID).setTile(m -> () -> new TileEntityOilCrackingUnit(m));
    public static MultiMachine ADVANCED_MINER = new MultiMachine(Ref.ID, "advanced_miner", LV, GUI, ITEM).setTile(m -> () -> new TileEntityAdvancedMiner(m));
    public static MultiMachine PYROLYSIS_OVEN = new MultiMachine(Ref.ID, "pyrolysis_oven", MV, GUI, ITEM, FLUID).setTile(m -> () -> new TileEntityPyrolysisOven(m));
    public static MultiMachine COMBUSTION_ENGINE = new MultiMachine(Ref.ID, "combustion_engine", COMBUSTION_FUELS, EV, GUI, FLUID).setTile(m -> () -> new TileEntityCombustionEngine(m));
    public static MultiMachine FUSION_REACTOR = new MultiMachine(Ref.ID, "fusion_reactor", FUSION, LUV, ZPM, UV, GUI, FLUID).setTile(m -> () -> new TileEntityFusionReactor(m));
    ...
    public static TankMachine QUANTUM_TANK = new TankMachine(Ref.ID, "quantum_tank", GUI);

    public static BasicMachine STEAM_GENERATOR = new BasicMachine(Ref.ID, "steam_generator", STEAM_FUELS, LV, MV, HV, GUI, ITEM, FLUID, GENERATOR);
    public static BasicMachine GAS_GENERATOR = new BasicMachine(Ref.ID, "gas_generator", GAS_FUELS, LV, MV, HV, GUI, ITEM, FLUID);
    public static BasicMachine COMBUSTION_GENERATOR = new BasicMachine(Ref.ID, "combustion_generator", COMBUSTION_FUELS, LV, MV, HV, GUI, ITEM, FLUID);
    public static BasicMachine NAQUADAH_GENERATOR = new BasicMachine(Ref.ID, "naquadah_generator", NAQUADAH_FUELS, EV, IV, LUV, GUI, ITEM, FLUID);
    public static BasicMachine PLASMA_GENERATOR = new BasicMachine(Ref.ID, "plasma_generator", PLASMA_FUELS, IV, LUV, ZPM, GUI, ITEM, FLUID, GENERATOR);
    ...
    public static BasicMachine BATTERY_BUFFER_FOUR = new BasicMachine(Ref.ID, "battery_buffer_four", GUI, ENERGY, CONFIGURABLE, ITEM).setTile(m -> () -> new TileEntityBatteryBuffer(m));
    public static BasicMachine BATTERY_BUFFER_ONE = new BasicMachine(Ref.ID, "battery_buffer_one", GUI, ENERGY, CONFIGURABLE, ITEM).setTile(m -> () -> new TileEntityBatteryBuffer(m));
    public static BasicMachine BATTERY_BUFFER_NINE = new BasicMachine(Ref.ID, "battery_buffer_nine", GUI, ENERGY, CONFIGURABLE, ITEM).setTile(m -> () -> new TileEntityBatteryBuffer(m));
