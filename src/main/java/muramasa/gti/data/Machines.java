...
public class Machines {
    ...
    public static BasicMachine PULVERIZER = new BasicMachine(Ref.ID, "pulverizer").setMap(PULVERIZING).custom().addFlags(GUI, ITEM).setGuiTiers(ImmutableMap.<Tier, Tier>builder().put(HV, HV).put(EV, EV).put(IV, IV));
    ...
    public static BasicMachine DISTILLERY = new BasicMachine(Ref.ID, "distillery").setMap(DISTILLING).addFlags(GUI, ITEM, FLUID).custom().renderContainedLiquids().setAllowVerticalFacing(true);
