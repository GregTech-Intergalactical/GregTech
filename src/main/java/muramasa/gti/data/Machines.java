...
public class Machines {
    ...
    public static SteamMachine LAVA_BOILER = new SteamMachine(Ref.ID, "lava_boiler").setMap(LAVA_BOILERS).setTiers(BRONZE,STEEL).addFlags(GUI, STEAM, ITEM, FLUID).baseTexture(Textures.BOILER_HANDLER).setTile(m -> () -> new TileEntityLavaBoiler(m));
