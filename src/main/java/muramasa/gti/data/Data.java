...
public class Data {
    ...
    public static final FluidPipe<?> FLUID_PIPE_BRICK = new FluidPipe<>(Ref.ID, Brick, 1000, false).sizes(PipeSize.SMALL, PipeSize.NORMAL, PipeSize.LARGE).caps(10, 10, 30, 60, 60, 60).pressures(500, 500, 500, 500, 500, 500);
    public static final FluidPipe<?> FLUID_PIPE_RUBBER = new FluidPipe<>(Ref.ID, Rubber, 100, true).caps(10).pressures(600);
    public static final FluidPipe<?> FLUID_PIPE_COPPER = new FluidPipe<>(Ref.ID, Copper, 1000, true).caps(10).pressures(700);
    public static final FluidPipe<?> FLUID_PIPE_BLACK_BRONZE = new FluidPipe<>(Ref.ID, BlackBronze, 1300, true).caps(20).pressures(800);
    public static final FluidPipe<?> FLUID_PIPE_PLASTIC = new FluidPipe<>(Ref.ID, Plastic, 150, true).caps(60).pressures(2000);
    public static final FluidPipe<?> FLUID_PIPE_STAINLESS_STEEL = new FluidPipe<>(Ref.ID, StainlessSteel, 1500, true).caps(60).pressures(1000);
    public static final FluidPipe<?> FLUID_PIPE_TITANIUM = new FluidPipe<>(Ref.ID, Titanium, 1800, true).caps(80).pressures(2500);
    public static final FluidPipe<?> FLUID_PIPE_TUNGSTEN_STEEL = new FluidPipe<>(Ref.ID, TungstenSteel, 2000, true).caps(100).pressures(5000);
    public static final FluidPipe<?> FLUID_PIPE_POLY = new FluidPipe<>(Ref.ID, Polytetrafluoroethylene, 500, true).caps(480).pressures(1000);
    public static final FluidPipe<?> FLUID_PIPE_HP = new FluidPipe<>(Ref.ID, HighPressure, 2000, true).sizes(PipeSize.SMALL, PipeSize.NORMAL, PipeSize.LARGE).caps(4800, 4800, 4800, 7200, 9600, 9600).pressures(10000);
    ...
    public static final ItemPipe<?> ITEM_PIPE_WOOD = new ItemPipe<>(Ref.ID, Wood).caps(1).sizes(PipeSize.SMALL);
    public static final ItemPipe<?> ITEM_PIPE_WROUGHT_IRON = new ItemPipe<>(Ref.ID, WroughtIron).caps(1).sizes(PipeSize.SMALL, PipeSize.NORMAL, PipeSize.LARGE);
    public static final ItemPipe<?> ITEM_PIPE_BISMUTH_BRONZE = new ItemPipe<>(Ref.ID, BismuthBronze).caps(2).sizes(PipeSize.SMALL, PipeSize.NORMAL, PipeSize.LARGE);
    ...
    public static final ItemPipe<?> ITEM_PIPE_STEEL = new ItemPipe<>(Ref.ID, Steel).caps(3).sizes(PipeSize.SMALL, PipeSize.NORMAL, PipeSize.LARGE);
    public static final ItemPipe<?> ITEM_PIPE_MAGNALIUM = new ItemPipe<>(Ref.ID, Magnalium).caps(4).sizes(PipeSize.SMALL, PipeSize.NORMAL, PipeSize.LARGE);
