...
public class RubberTreeWorldGen extends WorldGenBase<RubberTreeWorldGen> {
    ...
    final static TreeConfiguration RUBBER_TREE_CONFIG_SWAMP =
            (new TreeConfiguration.TreeConfigurationBuilder(RubberTree.TRUNK_BLOCKS, new SimpleStateProvider(GregTechData.RUBBER_LEAVES.defaultBlockState()),
                    new AcaciaFoliagePlacer(UniformInt.fixed(2), UniformInt.fixed(0)), new StraightTrunkPlacer(5, 2, 2), new TwoLayersFeatureSize(1, 0, 2))).ignoreVines().maxWaterDepth(1).build();

    final static TreeConfiguration RUBBER_TREE_CONFIG_JUNGLE =
            (new TreeConfiguration.TreeConfigurationBuilder(RubberTree.TRUNK_BLOCKS, new SimpleStateProvider(GregTechData.RUBBER_LEAVES.defaultBlockState()),
                    new AcaciaFoliagePlacer(UniformInt.fixed(2), UniformInt.fixed(0)), new StraightTrunkPlacer(7, 2, 2), new TwoLayersFeatureSize(1, 0, 2))).ignoreVines().build();
    ...
    final static TreeConfiguration RUBBER_TREE_CONFIG_NORMAL =
            (new TreeConfiguration.TreeConfigurationBuilder(RubberTree.TRUNK_BLOCKS, new SimpleStateProvider(GregTechData.RUBBER_LEAVES.defaultBlockState()),
                    new AcaciaFoliagePlacer(UniformInt.fixed(2), UniformInt.fixed(0)), new StraightTrunkPlacer(5, 2, 2), new TwoLayersFeatureSize(1, 0, 2))).ignoreVines().build();
