...
public class CrackingUnit {
    public static void init() {
        ...
        CRACKING.RB().ii(INT_CIRCUITS.get(2)).fi(Butene.getGas(1000),Hydrogen.getGas(2000)).fo(Propane.getGas(1000),Methane.getGas(1000)).add(100, 500);
        ...
        CRACKING.RB().ii(INT_CIRCUITS.get(1)).fi(Butadiene.getGas(1000),Hydrogen.getGas(4000)).fo(Butane.getGas(1000)).add(200, 500);
        //STEAM
        ...
        CRACKING.RB().ii(INT_CIRCUITS.get(2)).fi(Ethane.getGas(1000),Steam.getGas(1000)).fo(Methane.getGas(1000),Methanol.getLiquid(1000)).add(100, 172);
        CRACKING.RB().ii(INT_CIRCUITS.get(3)).fi(Ethane.getGas(1000),Steam.getGas(2000)).fo(Methanol.getLiquid(2000),Hydrogen.getGas(2000)).add(100, 172);
