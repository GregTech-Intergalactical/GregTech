...
public class MixerLoader {
    ...
    private static void recipes() {
        ...
        MIXING.RB().fi(Oxygen.getLiquid(1000),Dimethylhydrazine.getLiquid(1000)).fo(RocketFuel.getLiquid(3000)).add(3 * 20, 16);
        MIXING.RB().fi(DinitrogenTetroxide.getLiquid(1000),Dimethylhydrazine.getLiquid(1000)).fo(RocketFuel.getLiquid(6000)).add(3 * 20, 16);
        MIXING.RB().fi(LightDiesel.getLiquid(5000),HeavyDiesel.getLiquid(1000)).fo(Diesel.getLiquid(6000)).add(8 * 2, 120);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(WoodPulp,4))).fi(SulfuricAcid.getLiquid(1000)).io((List<ItemStack>) Items.CHARCOAL).fo(DilutedSulfuricAcid.getLiquid(1000)).add(60*20, 2);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Sugar,4))).fi(SulfuricAcid.getLiquid(1000)).io((List<ItemStack>) Items.CHARCOAL).fo(DilutedSulfuricAcid.getLiquid(1000)).add(60*20, 2);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Salt,2))).fi(Water.getLiquid(1000)).fo(SaltWater.getLiquid(1000)).add(2*20, 8);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Copper,3)),RecipeIngredient.of(DUST.get(Barium,2)),RecipeIngredient.of(DUST.get(Yttrium,1))).fi(Oxygen.getGas(7000)).io(DUST.get(YttriumBariumCuprate,13)).add(40*20, 8);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Talc,1))).fi(Oil.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Talc,1))).fi(Creosote.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Talc,1))).fi(SeedOil.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Soapstone,1))).fi(Oil.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Soapstone,1))).fi(Creosote.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Soapstone,1))).fi(SeedOil.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Redstone,1))).fi(Oil.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Redstone,1))).fi(Creosote.getLiquid(750)).fo(Lubricant.getLiquid(750)).add(64*2, 4);
        ...
        MIXING.RB().ii(RecipeIngredient.of(DUST.get(Stone,3)),RecipeIngredient.of(DUST.get(Clay,1))).fi(Water.getLiquid(500)).fo(Concrete.getLiquid(576)).add(1*20, 16);
    }
