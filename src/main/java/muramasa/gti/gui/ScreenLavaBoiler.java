...
public class ScreenLavaBoiler<T extends ContainerMachine<TileEntityLavaBoiler>> extends ScreenMachine<TileEntityLavaBoiler, T> {
    public ScreenLavaBoiler(T container, PlayerInventory inv, ITextComponent name) {
    ...
    protected void renderLabels(MatrixStack stack, int mouseX, int mouseY) {
        ...
        if (container.getTile().has(MachineFlag.FLUID)) {
            ...
            if (container.getTile() != null){
                TileEntityLavaBoiler tile = container.getTile();
    ...
    protected void renderBg(MatrixStack stack, float partialTicks, int mouseX, int mouseY) {
        ...
        if (container.getTile().has(MachineFlag.FLUID)) {
            ...
            if (container.getTile() instanceof TileEntityLavaBoiler){
                TileEntityLavaBoiler tile = (TileEntityLavaBoiler)container.getTile();
