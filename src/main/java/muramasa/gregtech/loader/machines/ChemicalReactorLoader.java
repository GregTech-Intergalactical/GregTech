...
public class ChemicalReactorLoader {
    ...
    private static void titanium() {
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Rutile, 1)),of(DUST.get(Carbon, 2))).fi(Chlorine.getGas(288)).fo(Titaniumtetrachloride.getLiquid(144),CarbonMonoxide.getGas(288)).add(500, 480);
    }

    private static void sulfuric() {
        CHEMICAL_REACTING.RB().fi(SulfuricTrioxide.getGas(144), Water.getLiquid(144)).fo(SulfuricAcid.getLiquid(144)).add(320, 7);
        CHEMICAL_REACTING.RB().fi(SulfuricDioxide.getGas(288), Oxygen.getGas(288)).fo(SulfuricTrioxide.getGas(288)).add(200, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur, 1))).fi(Oxygen.getGas(144)).fo(SulfuricDioxide.getGas(144)).add(60, 7);
        CHEMICAL_REACTING.RB().fi(HydrogenSulfide.getGas(288), Oxygen.getGas(3*144)).fo(SulfuricDioxide.getGas(288), Water.getLiquid(288)).add(120, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur,1))).fi(Hydrogen.getGas(144)).fo(HydrogenSulfide.getGas(144)).add(60, 8);
    }
    ...
    private static void rubber() {
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur), 1), of(DUST.get(RawRubber), 9)).fo(Rubber.getLiquid(144 * 9)).add(200, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur), 1), of(DUST.get(Polydimethylsiloxane), 9)).fo(SiliconRubber.getLiquid(144 * 9)).add(200, 32);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Sulfur), 1), of(DUST.get(RawStyreneButadieneRubber), 9)).fo(StyreneButadieneRubber.getLiquid(144 * 9)).add(200, 128);
        CHEMICAL_REACTING.RB().fi(Air.getGas(2000),Isoprene.getLiquid(144)).io(new ItemStack(DUST.get(RawRubber),1)).add(160, 30);
        CHEMICAL_REACTING.RB().fi(Oxygen.getGas(2000),Isoprene.getLiquid(144)).io(new ItemStack(DUST.get(RawRubber),3)).add(160, 30);
        CHEMICAL_REACTING.RB().fi(Air.getGas(2000),Styrene.getLiquid(36),Butadiene.getGas(108)).io(new ItemStack(DUST.get(RawStyreneButadieneRubber),1)).add(160, 240);
        CHEMICAL_REACTING.RB().fi(Oxygen.getGas(2000),Styrene.getLiquid(36),Butadiene.getGas(108)).io(new ItemStack(DUST.get(RawStyreneButadieneRubber),3)).add(160, 240);
    }
    ...
    private static void plastics() {
        ...
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(1).setNoConsume()).fi(Air.getGas(1000),VinylChloride.getGas(144)).io(DUST.get(PolyvinylChloride,1)).add(160, 30);
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(2000),VinylChloride.getGas(288)).io(DUST.get(PolyvinylChloride,3)).add(160, 30);
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(1).setNoConsume()).fi(Air.getGas(1000),Tetrafluoroethylene.getGas(144)).io(DUST.get(Polytetrafluoroethylene,1)).add(160, 30);
    ...
    private static void misc_carbohydrates() {
        ...
        CHEMICAL_REACTING.RB().fi(Heptanol.getLiquid(144),Epichlorohydrin.getLiquid(144)).ii(of(DUST.get(SodiumHydroxide,1))).fo(SaltWater.getLiquid(144)).io(INGOT.get(Epoxid,5)).add(160, 30);
        CHEMICAL_REACTING.RB().fi(Dichlorobenzene.getLiquid(144),Epichlorohydrin.getLiquid(144)).ii(of(DUST.get(SodiumSulfide,1))).fo(PolyphenyleneSulfide.getLiquid(144)).io(DUST.get(Salt,5)).add(160, 30);
        CHEMICAL_REACTING.RB().fi(Dimethyldichlorosilane.getLiquid(144),Water.getLiquid(288)).fo(HydrochloricAcid.getLiquid(288)).io(DUST.get(Polydimethylsiloxane,1)).add(240, 96);
        ...
        CHEMICAL_REACTING.RB().fi(AceticAcid.getLiquid(144),Methanol.getLiquid(144)).fo(MethylAcetate.getLiquid(144),Water.getLiquid(144)).add(240, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(SodiumHydroxide,1))).fi(Glycerol.getLiquid(144),HydrochloricAcid.getLiquid(144)).io(DUST.get(Salt,1)).fo(Epichlorohydrin.getLiquid(144),Water.getLiquid(288)).add(480, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(SodiumHydroxide),1)).fi(HypochlorousAcid.getLiquid(144),AllylChloride.getLiquid(144)).fo(Epichlorohydrin.getLiquid(144),SaltWater.getLiquid(144)).add(480, 30);
        CHEMICAL_REACTING.RB().fi(Hydrogen.getGas(3*144),CarbonDioxide.getGas(144)).fo(Methanol.getLiquid(144),Water.getLiquid(144)).add(360, 96);
        ...
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Silicon,1))).fi(Chloromethane.getLiquid(288)).fo(Dimethyldichlorosilane.getLiquid(144)).add(240, 96);
        CHEMICAL_REACTING.RB().fi(Ethylene.getGas(288),Oxygen.getGas(144),AceticAcid.getLiquid(288)).fo(VinylAcetate.getLiquid(288),Water.getLiquid(288)).add(180, 30);
        CHEMICAL_REACTING.RB().fi(Methanol.getLiquid(144),HydrochloricAcid.getLiquid(144)).fo(Chloromethane.getLiquid(144),Water.getLiquid(144)).add(160, 30);
    ...
    private static void inorganic_chemistry(){
        ...
        CHEMICAL_REACTING.RB().fi(NitrogenDioxide.getGas(3*144),Water.getLiquid(144)).fo(NitricOxide.getGas(144),NitricAcid.getLiquid(288)).add(40, 240);
        CHEMICAL_REACTING.RB().fi(Ammonia.getGas(4*144),Oxygen.getGas(5*144)).fo(NitricOxide.getGas(4*144),Water.getLiquid(6*144)).add(320, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon,1))).fi(CarbonDioxide.getGas(144)).fo(CarbonMonoxide.getGas(288)).add(800, 8);
        CHEMICAL_REACTING.RB().fi(Hydrogen.getGas(3*144),Nitrogen.getGas(288)).fo(Ammonia.getGas(288)).add(320, 384);
        CHEMICAL_REACTING.RB().fi(HypochlorousAcid.getLiquid(144),Ammonia.getGas(144)).fo(Chloramine.getLiquid(144),Water.getLiquid(144)).add(160, 30);
        CHEMICAL_REACTING.RB().fi(Methanol.getLiquid(288),Ammonia.getGas(144)).fo(Dimethylamine.getLiquid(144),Water.getLiquid(288)).add(240, 120);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Phosphorus, 4))).fi(Oxygen.getGas(5*144)).io(DUST.get(PhosphorousPentoxide, 1)).add(40, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon,2)),INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(144)).fo(CarbonMonoxide.getGas(288)).add(80, 8);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon,1)),INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(144)).fo(CarbonDioxide.getGas(144)).add(80, 8);
        CHEMICAL_REACTING.RB().fi(NitricAcid.getLiquid(4*144),MethylAcetate.getLiquid(288)).io(DUST.get(Carbon,5)).fo(Tetranitromethane.getLiquid(144),Water.getLiquid(8*144)).add(480, 120);
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(1).setNoConsume()).fi(Oxygen.getGas(7*144),Ammonia.getGas(4*144)).fo(DinitrogenTetroxide.getGas(288),Water.getLiquid(6*144)).add(480, 30);
        CHEMICAL_REACTING.RB().ii(INT_CIRCUITS.get(2).setNoConsume()).fi(Oxygen.getGas(288),Ammonia.getGas(144)).fo(NitricAcid.getLiquid(144),Water.getLiquid(144)).add(480, 30);
        ...
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Carbon,2)),of(DUST.get(Calcium,2))).fi(Oxygen.getGas(3*144)).io(DUST.get(Calcite,2)).add(500, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Quicklime,1))).fi(CarbonDioxide.getGas(144)).io(DUST.get(Calcite,1)).add(80, 30);
        CHEMICAL_REACTING.RB().ii(of(DUST.get(Magnesia,1))).fi(CarbonDioxide.getGas(144)).io(DUST.get(Magnesite,1)).add(80, 30);
